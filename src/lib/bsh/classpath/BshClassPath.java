...
public class BshClassPath implements ClassPathListener, NameSource {
	...
	/**
	 * @param topPath
	 *            indicates that this is the top level classpath component and
	 *            it should send the startClassMapping message
	 */
	...
	/*
	 * Note: we could probably do away with the unqualified name table in favor
	 * of a second name source
	 */
	...
	/*
	 * public void setNameCompletionIncludeUnqNames( boolean b ) { if (
	 * nameCompletionIncludesUnqNames != b ) { nameCompletionIncludesUnqNames =
	 * b; nameSpaceChanged(); } }
	 */
