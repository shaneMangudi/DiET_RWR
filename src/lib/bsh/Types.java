...
class Types {
	...
	static final int JAVA_BASE_ASSIGNABLE = 1, JAVA_BOX_TYPES_ASSIGABLE = 2, JAVA_VARARGS_ASSIGNABLE = 3,
			BSH_ASSIGNABLE = 4;
	...
	private static Object castObject(Class toType, Class fromType, Object fromValue, int operation, boolean checkOnly)
		...
		if (toType.isInterface() && lib.bsh.This.class.isAssignableFrom(fromType))
			return checkOnly ? VALID_CAST : ((lib.bsh.This) fromValue).getInterface(toType);
