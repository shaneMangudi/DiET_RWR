...
public class AWTConsole extends TextArea implements ConsoleInterface, Runnable, KeyListener {
	...
	/*
	 * Here's the really disguisting hack. We have to get to the peer because
	 * TextComponent will refuse to let us set us set a caret position greater
	 * than the text length. Great. What a piece of crap.
	 */
