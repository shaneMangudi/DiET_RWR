...
class Name implements java.io.Serializable {
	 ...
	 *            taken.
	 */
	synchronized public Object toObject(CallStack callstack, Interpreter interpreter, boolean forceClass)
	 ...
	 * identifier.
	 */
	private Object consumeNextObjectField(CallStack callstack, Interpreter interpreter, boolean forceClass,
			boolean autoAllocateThis) throws UtilEvalError {
		/*
		...
		if ((evalBaseObject == null || evalBaseObject instanceof This) && !forceClass) {
			...
			if (evalBaseObject == null) {
				...
				obj = resolveThisFieldReference(callstack, ((This) evalBaseObject).namespace, interpreter, varName,
						true);
			}
	 ...
	 *            top of the stack?
	 */
	Object resolveThisFieldReference(CallStack callstack, NameSpace thisNameSpace, Interpreter interpreter,
			String varName, boolean specialFieldsVisible) throws UtilEvalError {
	...
	*/
	synchronized public LHS toLHS(CallStack callstack, Interpreter interpreter) throws UtilEvalError {
		...
		if (obj instanceof This) {
			...
			if (evalName.equals("namespace") || evalName.equals("variables") || evalName.equals("methods")
			...
			throws EvalError/* , ReflectError, InvocationTargetException */
	{
		...
		if (commandObject == null) {
			...
			throw new EvalError("Command not found: " + StringUtil.methodString(commandName, argTypes), callerInfo,
					callstack);
		}
