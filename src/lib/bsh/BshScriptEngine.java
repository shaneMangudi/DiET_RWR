...
public class BshScriptEngine extends AbstractScriptEngine implements Compilable, Invocable {
	 ...
	 *            that instance. If classes are not supported in the scripting
	 *            language or if the procedure is not a member function of any
	 *            class, the argument must be {@code null}.
	 * @param args
