...
public class ButtonProperties extends PropertyMapContainer {
	...
	public static final IconProperty DISABLED_ICON = new IconProperty(PROPERTIES, "Disabled Icon",
			"Icon for the disabled button state.", PropertyMapValueHandler.INSTANCE);

	/**
	 * The enabled button tool tip text.
	 */
	public static final StringProperty TOOL_TIP_TEXT = new StringProperty(PROPERTIES, "Tool Tip Text",
			"The button tool tip text.", PropertyMapValueHandler.INSTANCE);
	 ...
	 *
	 * <p>
	 * The created button will be assigned the icon from {@link #ICON} or
	 * {@link #DISABLED_ICON} and the tool tip from {@link #TOOL_TIP_TEXT}. An
	 * action listener is also added to the button.
	 * </p>
	 */
	public static final ButtonFactoryProperty FACTORY = new ButtonFactoryProperty(PROPERTIES, "Factory",
			"The button factory. This factory is used to create a button. The "
					+ "created button will be assigned the icon from the '" + ICON.getName() + "' property or the '"
					+ DISABLED_ICON.getName() + "' property and the tool tip from the '" + TOOL_TIP_TEXT.getName()
