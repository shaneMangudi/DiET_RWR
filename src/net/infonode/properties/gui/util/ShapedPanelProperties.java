...
/**
 * Properties and property values for a shaped panel, which is a panel that can
 * have a {@link net.infonode.gui.shaped.border.ShapedBorder} and a
 * {@link ComponentPainter}.
 *
...
public class ShapedPanelProperties extends PropertyMapContainer {
	 ...
	 * @since ITP 1.4.0
	 */
	public static final BooleanProperty OPAQUE = new BooleanProperty(PROPERTIES, "Opaque",
			"If true the shaped panel is opaque. If false the shaped panel is transparent",
			PropertyMapValueHandler.INSTANCE);

	/**
	 * If true the shaped panel is flipped horizontally. Used by
	 * {@link ComponentPainter}'s,
	 * {@link net.infonode.gui.shaped.border.ShapedBorder}'s etc.
	 */
	public static final BooleanProperty HORIZONTAL_FLIP = new BooleanProperty(PROPERTIES, "Horizontal Flip",
			"If true the shaped panel is flipped horizontally. " + "Used by ComponentPainter's, ShapedBorder's etc.",
			PropertyMapValueHandler.INSTANCE);

	/**
	 * If true the shaped panel is flipped vertically. Used by
	 * {@link ComponentPainter}'s,
	 * {@link net.infonode.gui.shaped.border.ShapedBorder}'s etc.
	 */
	public static final BooleanProperty VERTICAL_FLIP = new BooleanProperty(PROPERTIES, "Vertical Flip",
			"If true the shaped panel is flipped vertically. " + "Used by ComponentPainter's, ShapedBorder's etc.",
			PropertyMapValueHandler.INSTANCE);

	/**
	 * If true the child components of the shaped panel are clipped with the
	 * border shape.
	 */
	public static final BooleanProperty CLIP_CHILDREN = new BooleanProperty(PROPERTIES, "Clip Children",
	 ...
	 */
	public static final ComponentPainterProperty COMPONENT_PAINTER = new ComponentPainterProperty(PROPERTIES,
			"Component Painter", "The component painter that paints the shaped panel background.",
			PropertyMapValueHandler.INSTANCE);

	/**
	 * The direction of the shaped panel. Used by {@link ComponentPainter}'s,
	 * {@link net.infonode.gui.shaped.border.ShapedBorder}'s etc.
	 */
	...
	static {
		...
		properties.setHorizontalFlip(false).setVerticalFlip(false).setComponentPainter(null)
	...
	/**
	 * Set to true if the shaped panel should be flipped horizontally. Used by
	 * {@link ComponentPainter}'s,
	 * {@link net.infonode.gui.shaped.border.ShapedBorder}'s etc.
	 *
	 * @param flip
	 *            true if the shaped panel should be flipped vertically
	 * @return this
	 */
	...
	/**
	 * Returns true if the shaped panel is flipped horizontally. Used by
	 * {@link ComponentPainter}'s,
	 * {@link net.infonode.gui.shaped.border.ShapedBorder}'s etc.
	 *
	...
	/**
	 * Set to true if the shaped panel should be flipped vertically. Used by
	 * {@link ComponentPainter}'s,
	 * {@link net.infonode.gui.shaped.border.ShapedBorder}'s etc.
	 *
	 * @param flip
	 *            true if the shaped panel should be flipped horizontally
	 * @return this
	 */
	...
	/**
	 * Returns true if the shaped panel is flipped vertically. Used by
	 * {@link ComponentPainter}'s,
	 * {@link net.infonode.gui.shaped.border.ShapedBorder}'s etc.
	 *
	...
	/**
	 * Set to true if the child components of the shaped panel should be clipped
	 * with the border shape.
	 *
	 * @param clipChildren
	 *            true if the child components of the shaped panel should be
	 *            clipped with the border shape
	 * @return this
	 */
	...
	/**
	 * Returns true the child components of the shaped panel are clipped with
	 * the border shape.
	 *
	 * @return true the child components of the shaped panel are clipped with
	 *         the border shape
	 */
	 ...
	 *
	 * @param painter
	 *            the painter that paints the shaped panel background, null for
	 *            none
	 * @return this
	 */
	...
	/**
	 * Sets the direction of the shaped panel. Used by {@link ComponentPainter}
	 * 's, {@link net.infonode.gui.shaped.border.ShapedBorder}'s etc.
	 *
	 * @param direction
	...
	/**
	 * Gets the direction of the shaped panel. Used by {@link ComponentPainter}
	 * 's, {@link net.infonode.gui.shaped.border.ShapedBorder}'s etc.
	 *
