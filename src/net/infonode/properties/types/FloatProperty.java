...
public class FloatProperty extends ValueHandlerProperty {
	 ...
	 * @param maxValue
	 *            the largest value that this property can have
	 * @param preferredDigitCount
	 *            the preferred number of digits to allocate space for in an
	 *            editor for a property value
	 * @param preferredDelta
	 *            the preferred amount to increase and decrease a property value
	 *            by
	 */
	public FloatProperty(PropertyGroup group, String name, String description, PropertyValueHandler valueHandler,
			float minValue, float maxValue, int preferredDigitCount, float preferredDelta) {
	...
	/**
	 * Returns the preferred amount to increase and decrease a property value
	 * by.
	 *
	...
	/**
	 * Returns the preferred number of digits to allocate space for in an editor
	 * for a property value.
	 *
	 * @return the preferred number of digits to allocate space for in an editor
	 *         for a property value
	 */
