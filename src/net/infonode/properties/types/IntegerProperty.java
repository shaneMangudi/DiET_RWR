...
public class IntegerProperty extends NumberProperty {
	 ...
	 *            handles values for this property
	 */
	public IntegerProperty(PropertyGroup group, String name, String description, int min, int max,
	...
	/**
	 * Creates an integer property that can only be set to zero and positive
	 * integers.
	 *
	 * @param group
	 *            the property group
	 ...
	 * @param valueHandler
	 *            handles values for this property
	 * @return an an integer property that can only be set to zero and positive
	 *         integers
	 */
	public static IntegerProperty createPositive(PropertyGroup group, String name, String description,
			int preferredDigitCount, PropertyValueHandler valueHandler) {
