...
public class ButtonFactoryProperty extends ValueHandlerProperty {
	 ...
	 */
	public ButtonFactoryProperty(PropertyGroup group, String name, String description,
			PropertyValueHandler valueHandler) {
		super(group, name, ButtonFactory.class, description, valueHandler);
	}

	/**
	 * Returns the {@link ButtonFactory} value of this property in a value
	 * container.
	 *
	...
	/**
	 * Sets the {@link ButtonFactory} value of this property in a value
	 * container.
	 *
	 * @param valueContainer
	 *            the value container
