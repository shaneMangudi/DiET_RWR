...
public class ComponentPainterProperty extends ValueHandlerProperty {
	public ComponentPainterProperty(PropertyGroup group, String name, String description,
			PropertyValueHandler valueStorage) {
		super(group, name, ComponentPainter.class, description, valueStorage);
	}

	/**
	 * Returns the {@link ComponentPainter} value of this property in a value
	 * container.
	 *
	...
	/**
	 * Sets the {@link ComponentPainter} value of this property in a value
	 * container.
	 *
	 * @param valueContainer
	 *            the value container
	 * @param componentPainter
	 *            the {@link ComponentPainter} value
	 */
