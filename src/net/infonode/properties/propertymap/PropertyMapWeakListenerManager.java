...
/**
 * Handles weak {@link PropertyMap} listeners which are garbage collected and
 * removed from the {@link PropertyMap} object on which it listens when there
 * are no strong or soft references to the listeners.
 *
...
public class PropertyMapWeakListenerManager {
	...
	private static class PropertyChangeListenerRef extends ListenerRef implements PropertyChangeListener {
		...
		PropertyChangeListenerRef(PropertyChangeListener referent, ReferenceQueue q, PropertyMap map,
				Property property) {
			super(referent, q, map);
	 ...
	 *            the listener
	 */
	public static void addWeakPropertyChangeListener(PropertyMap map, Property property,
	 ...
	 * {@link #addWeakListener(PropertyMap, PropertyMapListener)}.
	 *
	 * @param map
	 *            the map on which the listener was added
	 * @param listener
	 *            the listener
	 */
	 ...
	 *            the map on which the listener was added
	 * @param property
	 *            the property on which the listener listens to changes
	 * @param listener
	 *            the listener
	 */
	public static void removeWeakPropertyChangeListener(PropertyMap map, Property property,
			PropertyChangeListener listener) {
	...
	/**
	 * Removes a listener previously added with
	 * {@link #addWeakTreeListener(PropertyMap, PropertyMapTreeListener)}.
	 *
	 * @param map
	 *            the map on which the listener was added
	 * @param listener
