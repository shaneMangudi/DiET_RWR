...
public class PropertyMapProperty extends PropertyGroupProperty {
	 ...
	 * @param propertyGroup
	 *            property maps for this property group can be values for this
	 *            property
	 */
	...
	/**
	 * Returns the property group which property maps can be used as values for
	 * this property.
	 *
	 * @return the property group which property maps can be used as values for
	 *         this property
	 */
	...
	/**
	 * Return the property valueContainer value for this property in the value
	 * container.
	 *
