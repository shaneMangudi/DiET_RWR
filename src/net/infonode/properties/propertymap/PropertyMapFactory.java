...
public class PropertyMapFactory {
	...
	/**
	 * Creates a property map that can contain values for properties in the
	 * given property group.
	 *
	 * @param propertyGroup
	 *            the property group
	...
	/**
	 * Creates a property map with the same property group as
	 * <tt>inheritFrom</tt>. <tt>inheritFrom</tt> is added as a super map to the
