...
/**
 * A group of properties. The group have a name and a description. It can also
 * have a super group from which it inherit all it's properties. You can think
 * of a property group as similar to a Java class, and properties similar to
 * class fields.
 *
...
public class PropertyGroup {
	...
	/**
	 * Creates a property group with a super group. All properties in the super
	 * group will be inherited to this group.
	 *
	 * @param superGroup
	 *            the super group of this group
	 * @param name
	 *            the name of the group
	 * @param description
	 *            the group description
	...
	/**
	 * Returns the number of properties in this group. This does not include
	 * properties in super groups.
	 *
	...
	/**
	 * Returns true if this group or one of it's super groups contains the
	 * property.
	 *
	 * @param property
	 *            the property
	 * @return true if this group or one of it's super groups contains the
	 *         property
	 */
	...
	/**
	 * Returns the property at the index, This does not include properties in
	 * super groups.
	 *
	 * @param index
	 *            the property index
	...
	/**
	 * Returns an array with the properties in this group. This does not include
	 * properties in super groups.
	 *
	...
	/**
	 * Returns the property with the given name. This includes properties in
	 * super groups.
	 *
	 * @param name
	 *            the property name
