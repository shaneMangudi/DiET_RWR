...
/**
 * A property is belongs to a {@link PropertyGroup} and contains name,
 * description, type etc. A property can have multiple values which can be
 * stored in any type of object.
 *
...
public interface Property {
	...
	/**
	 * Returns the value type of this property. The property can only be set to
	 * values that are of this class or a sub class of this class.
	 *
	 ...
	 * @return the value of this property in an valueContainer, null if the
	 *         container doesn't contain the value
	...
	void setValue(Object valueContainer, Object value)
			throws ImmutablePropertyException, InvalidPropertyException, InvalidPropertyValueException;
	...
	/**
	 * Returns true if the value of this property can be removed from the
	 * valueContainer.
	 *
	 * @param valueContainer
	 *            the object from which to remove the value
	 * @return true if the value of this property can be removed from the
	 *         valueContainer
	 */
	 ...
	 * @throws CantRemoveValueException
	 *             if the property value can't be removed from the
	 *             valueContainer
	 */
