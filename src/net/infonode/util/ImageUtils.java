...
public final class ImageUtils {
	...
	public static final void waitImage(Image image) throws ImageException {
		MediaTracker tracker = new MediaTracker(new Canvas()); // use dummy
																// component
	...
	public static int toIntColor(Int4 i) {
		return ((i.getD() << 8) & 0xff000000) | (i.getA() & 0xff0000) | ((i.getB() >> 8) & 0xff00)
				| ((i.getC() >> 16) & 0xff);
	}
	...
	public static AffineTransform createTransform(Direction direction, boolean horizontalFlip, boolean verticalFlip,
		...
		return new AffineTransform(m00, m10, m01, m11, m00 == -1 ? width : m01 == -1 ? height : 0,
