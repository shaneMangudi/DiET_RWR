...
/**
 * An iterator for a map. The iterator points to a map entry when it's created
 * so {@link #next} shouldn't be called at the start of the iteration.
 * <p>
 * Here's an example on how to iterate over a map: <code>
