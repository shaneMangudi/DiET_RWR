...
public final class CopyOnWriteArrayList {
	...
	/*
	 * private static class Iterator implements java.util.Iterator { private
	 * Object[] elements; private int size; private int index;
	 * 
	 * Iterator(Object[] elements, int size) { this.elements = elements;
	 * this.size = size; }
	 * 
