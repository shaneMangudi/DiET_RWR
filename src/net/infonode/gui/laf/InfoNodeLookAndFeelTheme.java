...
/**
 * A theme for InfoNode look and feel. The theme infers some default colors from
 * others, so modifying a color might affect other, unmodified colors.
 *
...
public class InfoNodeLookAndFeelTheme {
	...
	public static final Color DEFAULT_SELECTED_BACKGROUND_COLOR = Color.getHSBColor(PRIMARY_HUE,
			PRIMARY_SATURATION + 0.1f, PRIMARY_BRIGHTNESS);
	...
	public static final Color DEFAULT_DESKTOP_COLOR = Color.getHSBColor(PRIMARY_HUE - 0.02f, PRIMARY_SATURATION,
			PRIMARY_BRIGHTNESS);
	...
	public InfoNodeLookAndFeelTheme() {
		this("Default Theme", DEFAULT_CONTROL_COLOR, DEFAULT_PRIMARY_CONTROL_COLOR, DEFAULT_BACKGROUND_COLOR,
				DEFAULT_TEXT_COLOR, DEFAULT_SELECTED_BACKGROUND_COLOR, DEFAULT_SELECTED_TEXT_COLOR);
	}
	 ...
	 * @param controlColor
	 *            the background color for buttons, labels etc.
	 * @param primaryControlColor
	 *            the color of scrollbar "knobs", text and menu selection
	 *            background
	 * @param backgroundColor
	 *            the background color for viewports, tree's, tables etc.
	 * @param textColor
	 *            the text color
	 */
	public InfoNodeLookAndFeelTheme(String name, Color controlColor, Color primaryControlColor, Color backgroundColor,
			Color textColor) {
		this(name, controlColor, primaryControlColor, backgroundColor, textColor, primaryControlColor,
	 ...
	 *            the background color for buttons, labels etc.
	 * @param primaryControlColor
	 *            the color of scrollbar "knobs"
	 * @param backgroundColor
	 *            the background color for viewports, tree's, tables etc.
	 * @param textColor
	 *            the text color
	 * @param selectedBackgroundColor
	 *            the background color for selected text, selected menu items
	 * @param selectedTextColor
	 *            the text color for selected text, selected menu items
	 */
	public InfoNodeLookAndFeelTheme(String name, Color controlColor, Color primaryControlColor, Color backgroundColor,
			Color textColor, Color selectedBackgroundColor, Color selectedTextColor) {
		this(name, controlColor, primaryControlColor, backgroundColor, textColor, selectedBackgroundColor,
	 ...
	 *            the text color for selected text, selected menu items
	 * @param shadingFactor
	 *            the shading factor is used when calculating brighter and
	 *            darker control colors. A higher factor gives brighter and
	 *            darker colors.
	 */
	public InfoNodeLookAndFeelTheme(String name, Color controlColor, Color primaryControlColor, Color backgroundColor,
			Color textColor, Color selectedBackgroundColor, Color selectedTextColor, double shadingFactor) {
		this.name = name;
	...
	private void updateColors() {
		...
		primaryControlShadowColor = new ColorUIResource(
				ColorUtil.mult(primaryControlColor.getColor(), invShadeAmount2));
		primaryControlDarkShadowColor = new ColorUIResource(
				ColorUtil.mult(primaryControlColor.getColor(), invShadeAmount));

		scrollBarBackgroundColor.setDefaultColor(controlLightShadowColor);
		scrollBarBackgroundShadowColor = new ColorUIResource(
				ColorUtil.mult(scrollBarBackgroundColor.getColor(), invShadeAmount));
		...
		treeIconBackgroundColor
				.setDefaultColor(ColorUtil.blend(backgroundColor.getColor(), primaryControlColor.getColor(), 0.15f));

		activeInternalFrameTitleBackgroundColor.setDefaultColor(
				ColorUtil.blend(primaryControlColor.getColor(), ColorUtil.getOpposite(getTextColor()), 0.5f));
		activeInternalFrameTitleForegroundColor.setDefaultColor(getTextColor());
		activeInternalFrameTitleGradientColor
				.setDefaultColor(ColorUtil.mult(activeInternalFrameTitleBackgroundColor.getColor(), 1.2));
		...
		inactiveInternalFrameTitleGradientColor
				.setDefaultColor(ColorUtil.mult(inactiveInternalFrameTitleBackgroundColor.getColor(), 1.2));
		...
		textFieldBorder.setDefaultBorder(new BorderUIResource(
				new CompoundBorder(new LineBorder(controlDarkShadowColor), new EmptyBorder(1, 2, 1, 2))));
	...
	/**
	 * Returns the shading factor. The shading factor is used when calculating
	 * brighter and darker control colors. A higher factor gives brighter and
	 * darker colors.
	 *
	...
	/**
	 * Sets the shading factor. The shading factor is used when calculating
	 * brighter and darker control colors. A higher factor gives brighter and
	 * darker colors.
	 *
	 * @param shadingFactor
	...
	/**
	 * Gets the background color for {@link javax.swing.JViewport},
	 * {@link javax.swing.JTree}, {@link javax.swing.JTable} etc.
	 *
	 * @return the background color for {@link javax.swing.JViewport},
	 *         {@link javax.swing.JTree}, {@link javax.swing.JTable} etc.
	 */
	 ...
	 *
	 * @return the background color used for collapse and expand icons in a
	 *         {@link javax.swing.JTree}
	 */
	...
	/**
	 * Gets the background color used for selected {@link javax.swing.JMenuItem}
	 * 's.
	 *
	 * @return the background color used for selected
	 *         {@link javax.swing.JMenuItem}'s
	 */
	...
	/**
	 * Gets the foreground color used for selected {@link javax.swing.JMenuItem}
	 * 's.
	 *
	 * @return the foreground color used for selected
	 *         {@link javax.swing.JMenuItem}'s
	 */
	...
	/**
	 * Gets the control highlight color. By default this is a color a little
	 * brighter than the control color.
	 *
	...
	/**
	 * Gets the control light shadow color. By default this is a color a little
	 * darker than the control color.
	 *
	...
	/**
	 * Gets the control shadow color. By default this is a color a little darker
	 * than the control light shadow color.
	 *
	...
	/**
	 * Gets the control dark shadow color. By default this is a color a little
	 * darker than the control shadow color.
	 *
	...
	/**
	 * Gets the primary control highlight color. By default this color is the
	 * same as the control highlight color..
	 *
	...
	/**
	 * Gets the primary control shadow color. By default this is a color a
	 * little darker than the primary control color.
	 *
	...
	/**
	 * Gets the primary control dark shadow color. By default this is a color a
	 * little darker than the primary control shadow color.
	 *
	...
	/**
	 * Gets the background shadow color for {@link javax.swing.JScrollBar}'s. By
	 * default this is a color a little darker than the scroll bar background
	 * color.
	 *
	 * @return the background color for {@link javax.swing.JScrollBar}'s.
	 */
	...
	/**
	 * Gets the background color for active {@link javax.swing.JInternalFrame}
	 * 's.
	 *
	 * @return the background color for active
	 *         {@link javax.swing.JInternalFrame}'s
	 */
	...
	/**
	 * Gets the foreground color for active {@link javax.swing.JInternalFrame}
	 * 's.
	 *
	 * @return the foreground color for active
	 *         {@link javax.swing.JInternalFrame}'s
	 */
	 ...
	 *
	 * @return the gradient color for active {@link javax.swing.JInternalFrame}
	 *         's
	 */
	...
	/**
	 * Gets the background color for inactive {@link javax.swing.JInternalFrame}
	 * 's.
	 *
	 * @return the background color for inactive
	 *         {@link javax.swing.JInternalFrame}'s
	 */
	...
	/**
	 * Gets the foreground color for inactive {@link javax.swing.JInternalFrame}
	 * 's.
	 *
	 * @return the foreground color for inactive
	 *         {@link javax.swing.JInternalFrame}'s
	 */
	...
	/**
	 * Gets the gradient color for inactive {@link javax.swing.JInternalFrame}
	 * 's.
	 *
	 * @return the gradient color for inactive
	 *         {@link javax.swing.JInternalFrame}'s
	 */
	 ...
	 *
	 * @return the border around cells in {@link javax.swing.table.JTableHeader}
	 *         's
	 */
	 ...
	 * {@link javax.swing.JInternalFrame}'s.
	 *
	 * @return the icon to the left in the title bar of
	 *         {@link javax.swing.JInternalFrame}'s
	 */
	 ...
	 * {@link javax.swing.JInternalFrame}'s.
	 *
	 * @return the icon used in the minimize button in the title bar of
	 *         {@link javax.swing.JInternalFrame}'s
	 */
	 ...
	 * {@link javax.swing.JInternalFrame}'s.
	 *
	 * @param internalFrameMinimizeIcon
	 *            the icon
	 */
	 ...
	 * {@link javax.swing.JInternalFrame}'s.
	 *
	 * @param internalFrameMaximizeIcon
	 *            the icon
	 */
	 ...
	 * {@link javax.swing.JInternalFrame}'s.
	 *
	 * @return the icon used in the close button in the title bar of
	 *         {@link javax.swing.JInternalFrame}'s
	 */
	 ...
	 *
	 * @param internalFrameBorder
	 *            the border used around {@link javax.swing.JInternalFrame}'s
	 */
	...
	/**
	 * Gets the font used in the title of {@link javax.swing.JInternalFrame}'s.
	 * Defaults to the text font with bold style.
	 *
	 * @return the font used in the title of {@link javax.swing.JInternalFrame}
	 *         's
	 */
	...
	/**
	 * Sets the font used in the title of {@link javax.swing.JInternalFrame}'s.
	 * Defaults to the text font with bold style.
	 *
	 * @param internalFrameTitleFont
	 *            the font
	 */
	...
	/**
	 * Sets the background color used in {@link javax.swing.JViewport},
	 * {@link javax.swing.JTree}, {@link javax.swing.JTable} etc.
	 *
	 * @param c
	 *            the background color used in {@link javax.swing.JViewport},
	 *            {@link javax.swing.JTree}, {@link javax.swing.JTable} etc.
	 */
	...
	/**
	 * Gets the font used in {@link javax.swing.JOptionPane} buttons. Defaults
	 * to the text font with bold style.
	 *
	...
	/**
	 * Sets the font used in {@link javax.swing.JOptionPane} buttons. Defaults
	 * to the text font with bold style.
	 *
	 * @param optionPaneButtonFont
	 *            the font used in {@link javax.swing.JOptionPane} buttons
	 */
	 ...
	 *            the size of the {@link javax.swing.JSplitPane} divider
	 */
	...
	/**
	 * Gets the border used around {@link javax.swing.JTextField} (including
	 * spinners etc.).
	 *
	...
	/**
	 * Sets the border used around {@link javax.swing.JTextField} (including
	 * spinners etc.).
	 *
	 * @param textFieldBorder
	 *            the border used around {@link javax.swing.JTextField}
	 */
	 ...
	 *
	 * @param treeOpenIcon
	 *            the icon used with open nodes in a {@link javax.swing.JTree}
	 */
	 ...
	 *
	 * @param treeClosedIcon
	 *            the icon used with closed nodes in a {@link javax.swing.JTree}
	 */
	 ...
	 *
	 * @param treeLeafIcon
	 *            the icon used with leaf nodes in a {@link javax.swing.JTree}
	 */
	 ...
	 *
	 * @param menuBarBorder
	 *            the border used around {@link javax.swing.JMenuBar}'s
	 */
	 ...
	 *
	 * @param selectedTextBackgroundColor
	 ...
	 *
	 * @param desktopColor
	 *            the background color for a {@link javax.swing.JDesktopPane}
	 */
	 ...
	 * {@link javax.swing.JTree}.
	 *
	 * @param treeIconBackgroundColor
	 *            the background color for the expand/collapse icons in a
	 *            {@link javax.swing.JTree}
	 */
	 ...
	 *
	 * @param selectedMenuBackgroundColor
	 ...
	 *
	 * @param selectedMenuForegroundColor
	 ...
	 *
	 * @param scrollBarBackgroundColor
	 *            the {@link javax.swing.JScrollBar} background color
	 */
	 ...
	 *            the background color for the title of an active
	 *            {@link javax.swing.JInternalFrame}
	 */
	 ...
	 *            the gradient color for the title of an active
	 *            {@link javax.swing.JInternalFrame}
	 */
	 ...
	 *            the background color for the title of an inactive
	 *            {@link javax.swing.JInternalFrame}
	 */
	 ...
	 *            the gradient color for the title of an inactive
	 *            {@link javax.swing.JInternalFrame}
	 */
	 ...
	 *
	 * @param frameTitleFont
	 *            the title font of an {@link javax.swing.JInternalFrame}
	 */
	...
	/**
	 * Sets the button font for a {@link javax.swing.JOptionPane}. Default to
	 * the text font with bold style.
	 *
	 * @param optionPaneButtonFont
	 *            the button font for a {@link javax.swing.JOptionPane}
	 */
	 ...
	 * .
	 *
	 * @param tableHeaderCellBorder
	 *            the border for the cells of a
	 ...
	 *            the width of a {@link javax.swing.JScrollBar}
	 */
	 ...
	 *
	 * @param buttonMargin
	 *            the margin of a {@link javax.swing.JButton}
	 */
	 ...
	 *
	 * @param popupMenuBorder
	 *            the border of a {@link javax.swing.JPopupMenu}
	 */
	 ...
	 * {@link javax.swing.JInternalFrame}.
	 *
	 * @return the icon used in the iconify button in the title of a
	 *         {@link javax.swing.JInternalFrame}
	 */
	 ...
	 * {@link javax.swing.JInternalFrame}.
	 *
	 * @param internalFrameIconifyIcon
	 ...
	 *            the foreground color used in {@link javax.swing.JToolTip}
	 */
	...
	/**
	 * Gets the border used around list items in {@link javax.swing.JList}'s and
	 * {@link javax.swing.JComboBox}'s.
	 *
	 * @return the border used around list items in {@link javax.swing.JList}'s
	 *         and {@link javax.swing.JComboBox}'s
	 */
	...
	/**
	 * Sets the border used around list items in {@link javax.swing.JList}'s and
	 * {@link javax.swing.JComboBox}'s.
	 *
	 * @param listItemBorder
	 *            the border used around list items in {@link javax.swing.JList}
	 *            's and {@link javax.swing.JComboBox}'s
	 */
	 ...
	 * {@link javax.swing.JList}'s and {@link javax.swing.JComboBox}'s.
	 *
	 * @return the border used around the focused list item in
	 *         {@link javax.swing.JList}'s and {@link javax.swing.JComboBox}'s
	 */
	 ...
	 * {@link javax.swing.JList}'s and {@link javax.swing.JComboBox}'s.
	 *
	 * @param listFocusedItemBorder
	 *            the border used around the focused list item in
	 *            {@link javax.swing.JList}'s and {@link javax.swing.JComboBox}
	 *            's
	 */
