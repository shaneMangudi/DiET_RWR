...
/**
 * A Look and Feel that's based on Metal. It's slimmer and use other colors than
 * the standard Metal Look and Feel. Under Java 1.5 the currect Metal theme is
 * stored when the InfoNode Look and Feel is applied, and restored when another
 * Look and Feel is set. Under Java 1.4 or earlier it is not possible to get the
...
public class InfoNodeLookAndFeel extends MetalLookAndFeel {
	public static final UIManager.LookAndFeelInfo LOOK_AND_FEEL_INFO = new UIManager.LookAndFeelInfo("InfoNode",
			InfoNodeLookAndFeel.class.getName());
	 ...
	 *
	 * @param theme
	 *            the theme to use. Do not modify the theme after this
	...
	public void initialize() {
		...
		if (oldMetalTheme == null) {
			...
			try {
				oldMetalTheme = (MetalTheme) MetalLookAndFeel.class.getMethod("getCurrentTheme", (Class<?>) null)
	...
	protected void initComponentDefaults(UIDefaults table) {
		...
		Object[] defaults = { "SplitPane.dividerSize", new Integer(theme.getSplitPaneDividerSize()),
				// "SplitPaneDivider.border", new
				// BorderUIResource(splitPaneDividerBorder),
				...
				// "TabbedPane.selectedTabPadInsets", new InsetsUIResource(0, 0,
				// 0, 0),
				...
				"ComboBox.selectionBackground", theme.getSelectedMenuBackgroundColor(), "ComboBox.selectionForeground",
				...
				"ToolTip.foreground", theme.getTooltipForegroundColor(), "ToolTip.background",
				theme.getTooltipBackgroundColor(),

				"Viewport.background", theme.getBackgroundColor(),

				"ScrollBar.background", theme.getScrollBarBackgroundColor(), "ScrollBar.shadow",
				theme.getScrollBarBackgroundShadowColor(), "ScrollBar.width", new Integer(theme.getScrollBarWidth()),
				// "ScrollBar.border", new BorderUIResource(new
				// LineBorder(Color.GRAY, 1)),

				// "ScrollBar.thumb", new RelativeColor(thumbColor,
				// 0.8).getColor(),
				// "ScrollBar.thumbShadow", new RelativeColor(thumbColor,
				// 0.7).getColor(),
				// "ScrollBar.thumbHighlight", new RelativeColor(thumbColor,
				// 1).getColor(),

				/*
				 * "ScrollBar.thumb", new ColorUIResource(255, 255, 255),
				 * "ScrollBar.thumbShadow", new ColorUIResource(0, 255, 0),
				 * "ScrollBar.thumbHighlight", new ColorUIResource(255, 255,
				 * 255),
				 */
				...
				"InternalFrame.activeTitleGradient", theme.getActiveInternalFrameTitleGradientColor(), // ColorUtil.mult(theme.getActiveInternalFrameTitleBackgroundColor(),
																										// 1.2),
				...
				"InternalFrame.inactiveTitleGradient", theme.getInactiveInternalFrameTitleGradientColor(), // ColorUtil.mult(theme.getInactiveInternalFrameTitleBackgroundColor(),
																											// 1.2),
				"InternalFrame.icon", theme.getInternalFrameIcon(), "InternalFrame.iconifyIcon",
				theme.getInternalFrameIconifyIcon(), "InternalFrame.minimizeIcon", theme.getInternalFrameMinimizeIcon(),
				"InternalFrame.maximizeIcon", theme.getInternalFrameMaximizeIcon(), "InternalFrame.closeIcon",
				theme.getInternalFrameCloseIcon(), "InternalFrame.border", theme.getInternalFrameBorder(),
				"InternalFrame.titleFont", theme.getInternalFrameTitleFont(),

				"MenuBar.border", theme.getMenuBarBorder(),

				"MenuItem.border", menuItemBorder, "Menu.border", menuItemBorder,
				// "CheckBoxMenuItem.border", menuItemBorder,
				// "RadioButtonMenuItem.border", menuItemBorder,

				"Spinner.border", theme.getTextFieldBorder(), "Spinner.background",
				new ColorUIResource(theme.getBackgroundColor()),

				"PopupMenu.border", theme.getPopupMenuBorder(),

				"TextField.border", theme.getTextFieldBorder(), "FormattedTextField.border", theme.getTextFieldBorder(),

				// "Button.border", new BorderUIResource(buttonBorder),
				// "Button.disabledShadow", new ColorUIResource(Color.GREEN),
				// //ColorUtil.blend(textColor, controlColor, 0.5f)),
				"Button.textShiftOffset", new Integer(2), "Button.select", theme.getControlLightShadowColor(),
				// "Button.focus", focusColor,
				"Button.margin", theme.getButtonMargin(), "Button.disabledText", theme.getInactiveTextColor(),
				// "Button.background", buttonBackground.getColor(),

				"ToggleButton.margin", theme.getButtonMargin(), "ToggleButton.select",
				theme.getControlLightShadowColor(), "ToggleButton.textShiftOffset", new Integer(2),

				"Tree.openIcon", theme.getTreeOpenIcon(), "Tree.closedIcon", theme.getTreeClosedIcon(), "Tree.leafIcon",
				theme.getTreeLeafIcon(), "Tree.collapsedIcon",
				new IconUIResource(new TreeIcon(TreeIcon.PLUS, 10, 10, true, theme.getTextColor(),
						theme.getTreeIconBackgroundColor())),
				"Tree.expandedIcon",
				new IconUIResource(new TreeIcon(TreeIcon.MINUS, 10, 10, true, theme.getTextColor(),
						theme.getTreeIconBackgroundColor())),
				"Tree.leftChildIndent", new Integer(5), "Tree.rightChildIndent", new Integer(11),
				...
				"OptionPane.warningIcon", LookAndFeel.makeIcon(iconClass, "icons/Warn.gif"), "OptionPane.questionIcon",
				LookAndFeel.makeIcon(iconClass, "icons/Question.gif"), "OptionPane.buttonFont",
				theme.getOptionPaneButtonFont(), };

		table.putDefaults(defaults);
	}

	/**
	 * Installs this look and feel with the {@link UIManager}, if it's not
	 * already installed.
	 */
