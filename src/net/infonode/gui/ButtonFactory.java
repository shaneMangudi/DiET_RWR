...
public class ButtonFactory {
	...
	private static class ButtonHighlighter implements ComponentListener, HierarchyListener {
		...
		private void update() {
			...
			if (button.isEnabled() && (rollover || pressed)) {
				...
				backgroundColor = backgroundColor == null ? UIManagerUtil.getColor("control", Color.LIGHT_GRAY)
						: backgroundColor;
	...
	public static final JButton createFlatHighlightButton(Icon icon, String tooltipText, int padding, boolean focusable,
			ActionListener action) {
