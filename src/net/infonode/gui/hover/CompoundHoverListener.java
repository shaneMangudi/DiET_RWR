...
/**
 * CompoundHoverListener takes the two given hover listeners and calls the first
 * hover listener and then the second when the mouse is hovering. When the mouse
 * is no longer hovering, the second listener is called and then the first
 * listener is called.
 *
