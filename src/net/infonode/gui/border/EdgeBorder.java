...
public class EdgeBorder implements Border, Serializable {
	...
	public EdgeBorder(ColorProvider topLeftColor, ColorProvider bottomRightColor, boolean drawTop, boolean drawBottom,
			boolean drawLeft, boolean drawRight) {
		init(topLeftColor, bottomRightColor, drawTop, drawBottom, drawLeft, drawRight);
	}

	private void init(ColorProvider topLeftColor, ColorProvider bottomRightColor, boolean drawTop, boolean drawBottom,
			boolean drawLeft, boolean drawRight) {
