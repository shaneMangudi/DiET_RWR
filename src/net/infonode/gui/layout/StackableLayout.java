...
public class StackableLayout implements LayoutManager2 {
	...
	public void setUseSelectedComponentSize(boolean useSelectedComponentSize) {
		if (this.useSelectedComponentSize != useSelectedComponentSize) {
			 ...
			 * ((JComponent)container).revalidate(); else container.validate();
			 */
		}
	}
	...
	public Dimension preferredLayoutSize(Container parent) {
		return LayoutUtil
				.add(useSelectedComponentSize ? component == null ? new Dimension(0, 0) : component.getPreferredSize()
	...
	public void showComponent(Component c) {
		...
		boolean hasFocus = oldComponent != null && LayoutUtil
				.isDescendingFrom(KeyboardFocusManager.getCurrentKeyboardFocusManager().getFocusOwner(), oldComponent);
		 ...
		 * (oldComponent.getParent() == container && oldComponent != component)
		 * { oldComponent.setVisible(false); }
		 * 
