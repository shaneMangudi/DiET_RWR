...
public class ComponentUtil {
	...
	public static final String getBorderLayoutOrientation(Direction d) {
		return d == Direction.UP ? BorderLayout.NORTH
				: d == Direction.LEFT ? BorderLayout.WEST
						: d == Direction.DOWN ? BorderLayout.SOUTH : BorderLayout.EAST;
	}
	 ...
	 * reason calling {@link Component#requestFocusInWindow()}when the component
	 * is focus owner changes focus owner to another component!
	 *
	 * @param component
	...
	public static boolean requestFocus(Component component) {
		 ...
		 * System.identityHashCode(KeyboardFocusManager.
