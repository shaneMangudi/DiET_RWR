...
public class PopupList extends SimplePanel {
	...
	private class Popup extends JPopupMenu {
		...
		private JScrollPane scrollPane = new JScrollPane(list, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED,
		...
		private void update() {
			 ...
			 * ;
			 * list.setBackground(UIManagerUtil.getColor("ComboBox.background",
			 * "control")); list.setSelectionForeground(UIManagerUtil.getColor(
			 * "ComboBox.selectionForeground"));
			 * list.setSelectionBackground(UIManagerUtil.getColor(
			 * "ComboBox.selectionBackground")); list.setBorder(null);
			 */
			scrollPane.getViewport().setOpaque(false);
			scrollPane.setBorder(null);
		}
