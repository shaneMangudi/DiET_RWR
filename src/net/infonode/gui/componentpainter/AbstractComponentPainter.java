...
/**
 * An abstract base class for {@link ComponentPainter}'s. Default
 * implementations for both paint methods are provided, but becuase they call
 * each other a sub class must override one or both methods.
 *
