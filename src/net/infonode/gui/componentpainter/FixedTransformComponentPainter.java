...
/**
 * A painter that paints its wrapped painter using the same fixed values for
 * direction, horizontal flip and vertical flip.
 *
...
public class FixedTransformComponentPainter extends AbstractComponentPainterWrapper {
	...
	public FixedTransformComponentPainter(ComponentPainter painter, Direction direction, boolean horizontalFlip,
