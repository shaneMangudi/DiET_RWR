 ...
 * </p>
 * <p>
 * Note: New methods might be added to this interface in the future. To ensure
 * future compatibility inherit from {@link AbstractComponentPainter} instead of
...
public interface ComponentPainter {
	/**
	 * Paints an area of a component. The area should be painted the same way as
	 * for direction Direction.RIGHT without any flipping.
	 *
	 * @param component
	...
	/**
	 * Paints an area in a specific direction and optinally flipped horizontally
	 * and/or vertically. The flips are performed before the rotation is
	 * applied.
	 *
	 * @param component
	 *            the component to paint on
	 ...
	 *            the height
	 * @param direction
	 *            the direction, Direction.RIGHT is the normal direction
	 * @param horizontalFlip
	 *            flip the painted graphics horizontally
	 * @param verticalFlip
	...
	/**
	 * Returns an approximate average color of the pixels painted by this
	 * painter.
	 *
	 * @param component
	 *            the component to paint on
	 * @return an approximate average color of the pixels painted by this
	 *         painter
	 */
