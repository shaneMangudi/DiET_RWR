...
/**
 * Finds the most suitable background color of a component. If the component has
 * a {@link net.infonode.gui.componentpainter.ComponentPainter} that paint its
 * background, like for example a shaped panel, the color is taken from this
 * painter, otherwise the component background color is used.
 *
