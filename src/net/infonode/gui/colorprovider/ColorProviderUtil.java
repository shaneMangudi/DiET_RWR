...
public class ColorProviderUtil {
	...
	/**
	 * Returns a {@link ColorProvider} for the color. If the color is null the
	 * default provider is returned.
	 *
	 * @param color
	 *            the color for which to return a provider
	 * @param defaultProvider
	 *            the default provider
	 * @return a color provider for the color, if the color is null the default
