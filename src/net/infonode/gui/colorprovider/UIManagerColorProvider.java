...
/**
 * A {@link ColorProvider} which returns a property color from the
 * {@link UIManager}.
 *
...
public class UIManagerColorProvider extends AbstractColorProvider implements Serializable {
	 ...
	 *
	 * @param propertyName
	 *            the name of the property which value will be retrieved from
	 *            the {@link UIManager}.
	 */
	 ...
	 *            the {@link UIManager}.
	 * @param defaultColor
	 *            the color to be used if the specified color doesn't exist in
	 *            the UIManager
	 */
