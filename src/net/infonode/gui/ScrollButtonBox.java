...
public class ScrollButtonBox extends SimplePanel {
	...
	public ScrollButtonBox(boolean vertical, int iconSize) {
		this(vertical, ButtonFactory.createFlatHighlightButton(new ArrowIcon(iconSize, Direction.UP), "", 0, null),
	...
	public ScrollButtonBox(final boolean vertical, AbstractButton upButton, AbstractButton downButton,
			AbstractButton leftButton, AbstractButton rightButton) {
	...
	public void setButtons(AbstractButton upButton, AbstractButton downButton, AbstractButton leftButton,
	...
	/*
	 * private void update() { Color c1 =
	 * UIManager.getColor("Button.foreground"); Color c2 =
	 * UIManager.getColor("Button.disabledForeground");
	 * 
	 * if (c2 == null) c2 = ColorUtil.blend(c1,
	 * UIManager.getColor("Panel.background"), 0.7f);
	 * 
	 * button1.setIcon(new ArrowIcon(c1, iconSize, vertical ? Direction.UP :
	 * Direction.LEFT)); button2.setIcon(new ArrowIcon(c1, iconSize, vertical ?
	 * Direction.DOWN : Direction.RIGHT));
	 * 
	 * ArrowIcon icon = new ArrowIcon(c2, iconSize - 2, vertical ? Direction.UP
	 * : Direction.LEFT); icon.setShadowEnabled(false);
	 * button1.setDisabledIcon(new BorderIcon(icon, 1));
	 * 
	 * icon = new ArrowIcon(c2, iconSize - 2, vertical ? Direction.DOWN :
	 * Direction.RIGHT); icon.setShadowEnabled(false);
