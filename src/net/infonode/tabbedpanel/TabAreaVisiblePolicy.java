...
/**
 * TabAreaVisiblePolicy defines the visibility policies for the tab area of a
 * tabbed panel.
 *
...
public class TabAreaVisiblePolicy extends Enum {
	...
	/**
	 * Tabs exist visible policy. This means that the tab area will only be
	 * visible if it contains tabs.
	 */
	public static final TabAreaVisiblePolicy TABS_EXIST = new TabAreaVisiblePolicy(2, "Tabs Exist in Tab Area");

	/**
	 * More than one visible policy. This means that the tab area is visible
	 * when the tabbed panel contains more than one tab.
	 */
	public static final TabAreaVisiblePolicy MORE_THAN_ONE_TAB = new TabAreaVisiblePolicy(3, "More than One Tab");

	private static final TabAreaVisiblePolicy[] VISIBLE_POLICIES = new TabAreaVisiblePolicy[] { ALWAYS, NEVER,
			TABS_EXIST, MORE_THAN_ONE_TAB };
