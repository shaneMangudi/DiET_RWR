 ...
 *
 * <p>
 * Adding a TabListener to a tabbed panel or a tab makes it possible to receive
 * events when a tab component is added, removed, moved, highlighted,
 * dehighlighted, selected, deselected, dragged, dropped or drag aborted.
 * </p>
 *
...
public interface TabListener {
	 ...
	 *
	 * <p>
	 * <strong>Note:</strong> The event contains information about the
	 * previously selected tab and the current selected tab.
	 * </p>
	 *
	 * @param event
	 *            the event
	 ...
	 * <p>
	 * <strong>Note:</strong> The event contains information about the
	 * previously highlighted tab and the current selected tab.
	 * </p>
	 *
	 * @param event
	 *            the event
	...
	/**
	 * Called when a tab is moved, i.e. dragged to another position in the tab
	 * area
	 *
	 * @param event
	 *            the event
