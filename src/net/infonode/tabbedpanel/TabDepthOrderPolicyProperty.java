...
public class TabDepthOrderPolicyProperty extends EnumProperty {
	 ...
	 */
	public TabDepthOrderPolicyProperty(PropertyGroup group, String name, String description,
			PropertyValueHandler valueStorage) {
		super(group, name, TabDepthOrderPolicy.class, description, valueStorage,
