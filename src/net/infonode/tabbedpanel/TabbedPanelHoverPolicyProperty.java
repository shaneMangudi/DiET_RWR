...
public class TabbedPanelHoverPolicyProperty extends EnumProperty {
	 ...
	 */
	public TabbedPanelHoverPolicyProperty(PropertyGroup group, String name, String description,
			PropertyValueHandler valueStorage) {
		super(group, name, TabbedPanelHoverPolicy.class, description, valueStorage,
