...
/**
 * Tabbed panel button properties contains properties objects for all buttons in
 * a tabbed panel.
 *
...
public class TabbedPanelButtonProperties extends PropertyMapContainer {
	...
	public static final PropertyMapProperty SCROLL_UP_BUTTON_PROPERTIES = new PropertyMapProperty(PROPERTIES,
			"Scroll Up Button Properties", "Properties for scroll up button.", ButtonProperties.PROPERTIES);
	...
	public static final PropertyMapProperty SCROLL_LEFT_BUTTON_PROPERTIES = new PropertyMapProperty(PROPERTIES,
			"Scroll Left Button Properties", "Properties for scroll left button.", ButtonProperties.PROPERTIES);
	...
	public static final PropertyMapProperty SCROLL_DOWN_BUTTON_PROPERTIES = new PropertyMapProperty(PROPERTIES,
			"Scroll Down Button Properties", "Properties for scroll down button.", ButtonProperties.PROPERTIES);
	...
	public static final PropertyMapProperty SCROLL_RIGHT_BUTTON_PROPERTIES = new PropertyMapProperty(PROPERTIES,
			"Scroll Right Button Properties", "Properties for scroll right button.", ButtonProperties.PROPERTIES);
	...
	public static final PropertyMapProperty TAB_DROP_DOWN_LIST_BUTTON_PROPERTIES = new PropertyMapProperty(PROPERTIES,
			"Tab Drop Down List Button Properties", "Properties for the tab drop down list button.",
	...
	/**
	 * Constructs a TabbedPanelButtonProperties object with the given object as
	 * property storage
	 *
	 * @param object
	...
	/**
	 * Constructs a TabbedPanelButtonProperties object that inherits its
	 * properties from the given TabbedPanelButtonProperties object
	 *
	 * @param inheritFrom
