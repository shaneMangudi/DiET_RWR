 ...
 * properties for a hovered {@link TitledTab} and the {@link TabbedPanel} it is
 * a member of. The action is meant to be set as a {@link HoverListener} for a
 * TitledTab in the
 ...
 * {@link net.infonode.tabbedpanel.hover.TabbedPanelTitledTabHoverAction}
 * instead.
 * </p>
 *
 * @author johan
...
public class TitledTabTabbedPanelHoverAction implements HoverListener {
	 ...
	 *
	 * @param allTabs
	 *            true if the TabbedPanelProperties should be applied to the
	 ...
	 * hovered.
	 *
	 * @param titledTabProperties
	 *            reference to a TitledTabProperties object
	 * @param tabbedPanelProperties
	 ...
	 */
	public TitledTabTabbedPanelHoverAction(TitledTabProperties titledTabProperties,
			TabbedPanelProperties tabbedPanelProperties, boolean allTabs) {
