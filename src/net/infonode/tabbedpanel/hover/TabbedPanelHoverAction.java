...
/**
 * <p>
 * TabbedPanelHoverAction is an action that makes it easy to change properties
 * for a hovered {@link TabbedPanel}. The action is meant to be set as a
 * {@link HoverListener} for the entire tabbed panel, the tab area, the tab area
 * components area and/or the content area in their corresponding properties
 * objects.
 * </p>
 *
 * <p>
...
public class TabbedPanelHoverAction implements HoverListener {
	...
	/**
	 * Creates a TabbedPanelHoverAction containing an empty
	 * TabbedPanelProperties object.
	 */
