...
public class TabbedPanelReleaseInfo {
	private static ReleaseInfo productInfo = new ReleaseInfo("InfoNode Tabbed Panel GPL", "NNL Technology AB",
			AntUtils.getBuildTime(1170278669833L), AntUtils.createProductVersion(1, 5, 0),
