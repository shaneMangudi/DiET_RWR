 ...
 * {@link TabbedPanelContentPanel}. These properties affects the content area of
 * a TabbedPanel. TabbedPanelProperties contains
...
public class TabbedPanelContentPanelProperties extends PropertyMapContainer {
	...
	public static final PropertyMapProperty COMPONENT_PROPERTIES = new PropertyMapProperty(PROPERTIES,
			"Component Properties", "Properties for the content area component.", ComponentProperties.PROPERTIES);
	...
	public static final PropertyMapProperty SHAPED_PANEL_PROPERTIES = new PropertyMapProperty(PROPERTIES,
			"Shaped Panel Properties", "Properties for shaped tab area components area.",
	...
	/**
	 * Constructs a TabbedPanelContentPanelProperties map with the given map as
	 * property storage
	 *
	 * @param map
	...
	/**
	 * Constructs a TabbedPanelContentPanelProperties object that inherits its
	 * properties from the given TabbedPanelContentPanelProperties object
	 *
	 * @param inheritFrom
	...
	/**
	 * <p>
	 * Sets the hover listener that will be triggered when the content area is
	 * hoverd by the mouse.
	 * </p>
	 *
	 * <p>
	 * The tabbed panel that the hovered content area is part of will be the
	 * source of the hover event sent to the hover listener.
	 * </p>
	 *
	 * @param listener
	 *            the hover listener
	...
	/**
	 * <p>
	 * Gets the hover listener that will be triggered when the content area is
