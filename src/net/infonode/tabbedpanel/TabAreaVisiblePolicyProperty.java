...
public class TabAreaVisiblePolicyProperty extends EnumProperty {
	 ...
	 */
	public TabAreaVisiblePolicyProperty(PropertyGroup group, String name, String description,
			PropertyValueHandler valueStorage) {
		super(group, name, TabAreaVisiblePolicy.class, description, valueStorage,
