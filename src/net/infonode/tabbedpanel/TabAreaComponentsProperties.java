...
public class TabAreaComponentsProperties extends PropertyMapContainer {
	 ...
	 */
	public static final BooleanProperty STRETCH_ENABLED = new BooleanProperty(PROPERTIES, "Stretch Enabled",
	...
	public static final PropertyMapProperty COMPONENT_PROPERTIES = new PropertyMapProperty(PROPERTIES,
			"Component Properties", "Properties for tab area components area.", ComponentProperties.PROPERTIES);
	...
	/**
	 * Constructs a TabAreaComponentsProperties object that inherits its
	 * properties from the given TabAreaComponentsProperties object
	 *
	 * @param inheritFrom
	...
	/**
	 * <p>
	 * Sets the hover listener that will be triggered when the tab area
	 * components area is hoverd by the mouse.
	 * </p>
	 *
	 * <p>
	 * The tabbed panel that the hovered tab area components area is part of
	 * will be the source of the hover event sent to the hover listener.
	 * </p>
	 *
	 * @param listener
	 *            the hover listener
	...
	/**
	 * <p>
	 * Gets the hover listener that will be triggered when the tab area
	 * components area is hovered by the mouse.
	 * </p>
	 *
	 * <p>
	 * The tabbed panel that the hovered tab area components area is part of
