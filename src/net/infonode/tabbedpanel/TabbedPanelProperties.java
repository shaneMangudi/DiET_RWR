 ...
 * content area, the tab area, the tab area components and the buttons of the
 * TabbedPanel.
 *
...
public class TabbedPanelProperties extends PropertyMapContainer {
	 ...
	 */
	public static final BooleanProperty TAB_REORDER_ENABLED = new BooleanProperty(PROPERTIES, "Tab Reorder Enabled",
			"Tab reorder enabled or disabled", PropertyMapValueHandler.INSTANCE);
	...
	public static final IntegerProperty ABORT_DRAG_KEY = IntegerProperty.createPositive(PROPERTIES,
			"Abort Drag Key Code", "Key code for aborting drag", 3, PropertyMapValueHandler.INSTANCE);
	...
	public static final TabLayoutPolicyProperty TAB_LAYOUT_POLICY = new TabLayoutPolicyProperty(PROPERTIES,
			"Layout Policy", "Tab layout in tab area", PropertyMapValueHandler.INSTANCE);
	...
	public static final TabDropDownListVisiblePolicyProperty TAB_DROP_DOWN_LIST_VISIBLE_POLICY = new TabDropDownListVisiblePolicyProperty(
			PROPERTIES, "Tab Drop Down List Visible Policy",
	...
	public static final TabSelectTriggerProperty TAB_SELECT_TRIGGER = new TabSelectTriggerProperty(PROPERTIES,
			"Tab Select Trigger", "Determins when a tab should be selected", PropertyMapValueHandler.INSTANCE);
	...
	public static final IntegerProperty TAB_SCROLLING_OFFSET = IntegerProperty.createPositive(PROPERTIES,
			"Scroll Offset", "Number of pixels to be shown for the last scrolled tab", 3,
			PropertyMapValueHandler.INSTANCE);
	 ...
	 */
	public static final BooleanProperty ENSURE_SELECTED_VISIBLE = new BooleanProperty(PROPERTIES,
			"Ensure Selected Visible", "Upon select, the selected tab will be scrolled into the visible area.",
			PropertyMapValueHandler.INSTANCE);
	 ...
	 */
	public static final DirectionProperty TAB_AREA_ORIENTATION = new DirectionProperty(PROPERTIES,
			"Tab Area Orientation", "Tab area's orientation relative to the content area.",
			PropertyMapValueHandler.INSTANCE);
	...
	public static final IntegerProperty TAB_SPACING = new IntegerProperty(PROPERTIES, "Tab Spacing",
			...
			Integer.MIN_VALUE, Integer.MAX_VALUE, 3, PropertyMapValueHandler.INSTANCE);
	...
	public static final PropertyMapProperty CONTENT_PANEL_PROPERTIES = new PropertyMapProperty(PROPERTIES,
			"Content Panel Properties", "Content panel properties.", TabbedPanelContentPanelProperties.PROPERTIES);
	...
	public static final PropertyMapProperty TAB_AREA_PROPERTIES = new PropertyMapProperty(PROPERTIES,
			"Tab Area Properties", "Tab area properties.", TabAreaProperties.PROPERTIES);
	...
	public static final PropertyMapProperty TAB_AREA_COMPONENTS_PROPERTIES = new PropertyMapProperty(PROPERTIES,
			"Tab Area Components Properties", "Tab area components properties.",
	...
	public static final PropertyMapProperty BUTTON_PROPERTIES = new PropertyMapProperty(PROPERTIES,
			"Tabbed Panel Button Properties", "Tabbed panel button properties.",
	...
	public static final TabbedPanelHoverPolicyProperty HOVER_POLICY = new TabbedPanelHoverPolicyProperty(PROPERTIES,
			"Hover Policy", "Policy for when the Tabbed Panel is considerd hovered by the mouse.",
			PropertyMapValueHandler.INSTANCE);
	 ...
	 * @see #getShadowSize
	 */
	public static final IntegerProperty SHADOW_SIZE = IntegerProperty.createPositive(PROPERTIES, "Shadow Size",
			"The size of the tab shadow.", 2, PropertyMapValueHandler.INSTANCE);
	...
	public static final IntegerProperty SHADOW_BLEND_AREA_SIZE = IntegerProperty.createPositive(PROPERTIES,
			"Shadow Blend Size", "The size of the tab shadow blend area.", 2, PropertyMapValueHandler.INSTANCE);
	 ...
	 * @see #getShadowColor
	 */
	public static final ColorProperty SHADOW_COLOR = new ColorProperty(PROPERTIES, "Shadow Color",
			"The color of the shadow.", PropertyMapValueHandler.INSTANCE);
	 ...
	 */
	public static final FloatProperty SHADOW_STRENGTH = new FloatProperty(PROPERTIES, "Shadow Strength",
	 ...
	 */
	public static final Property[] FUNCTIONAL_PROPERTIES = { TAB_REORDER_ENABLED, ABORT_DRAG_KEY, TAB_LAYOUT_POLICY,
			ENSURE_SELECTED_VISIBLE, AUTO_SELECT_TAB, TAB_DESELECTABLE, TAB_SELECT_TRIGGER, HOVER_POLICY };

	/**
	 * Array with all properties that controls the shadow
	 */
	public static final Property[] SHADOW_PROPERTIES = { SHADOW_ENABLED, SHADOW_SIZE, SHADOW_BLEND_AREA_SIZE,
			SHADOW_COLOR, SHADOW_STRENGTH };
	...
	public static final Property[] TABS_VISUAL_PROPERTIES = { TAB_SCROLLING_OFFSET, TAB_SPACING, TAB_AREA_ORIENTATION,
			TAB_AREA_PROPERTIES, TAB_AREA_COMPONENTS_PROPERTIES, TAB_LAYOUT_POLICY, CONTENT_PANEL_PROPERTIES,
	...
	public static final Property[] VISUAL_PROPERTIES = (Property[]) ArrayUtil.append(TABS_VISUAL_PROPERTIES,
			SHADOW_PROPERTIES, new Property[TABS_VISUAL_PROPERTIES.length + SHADOW_PROPERTIES.length]);

	private static final TabbedPanelProperties DEFAULT_PROPERTIES = new TabbedPanelProperties(
			PROPERTIES.getDefaultMap());
		...
		PropertyMapManager.runBatch(new Runnable() {
			public void run() {
				DEFAULT_PROPERTIES.getContentPanelProperties().getComponentProperties()
						.setBorder(new OpenContentBorder(TabbedUIDefaults.getDarkShadow(),
								TabbedUIDefaults.getHighlight()))
	...
	private static void updateFunctionalProperties() {
		DEFAULT_PROPERTIES.setTabReorderEnabled(false).setAbortDragKey(KeyEvent.VK_ESCAPE)
				.setTabLayoutPolicy(TabLayoutPolicy.SCROLLING)
				.setTabDropDownListVisiblePolicy(TabDropDownListVisiblePolicy.NEVER)
				.setTabSelectTrigger(TabSelectTrigger.MOUSE_PRESS).setTabScrollingOffset(10).setTabSpacing(-1)
				.setTabDepthOrderPolicy(TabDepthOrderPolicy.DESCENDING).setEnsureSelectedTabVisible(false)
				...
				.setShadowEnabled(false).setShadowSize(3).setShadowBlendAreaSize(2).setShadowColor(Color.BLACK)
	 ...
	 *
	 * @param oldSuperObject
	 *            old super object
	 * @param newSuperObject
	 *            new super object
	 * @return this
	 * @since ITP 1.4.0
	 */
	public TabbedPanelProperties replaceSuperObject(TabbedPanelProperties oldSuperObject,
	 ...
	 *
	 * @param value
	 *            true for automactic selection, otherwise false
	 * @return this TabbedPanelProperties
	 */
	 ...
	 *
	 * @param value
	 *            true for deselectable, otherwise false
	 * @return this TabbedPanelProperties
	 */
	 ...
	 *
	 * @param value
	 *            true for selected visible, otherwise false
	 * @return this TabbedPanelProperties
	 * @see #setTabLayoutPolicy
	 */
	 ...
	 *
	 * @param enabled
	 *            true for enabled, otherwise disabled
	 * @return this TabbedPanelProperties
	 */
	 ...
	 *            true if the tab pressed with the mouse should be highlighted
	 * @return this
	 */
	 ...
	 * the {@link net.infonode.gui.icon.IconProvider} and the text will be
	 * retrieved by calling toString() on the tab.
	 * </p>
	 *
	 * @param policy
	 ...
	 *
	 * <p>
	 * This can be a negative value i.e. tabs will be overlapping each other.
	 * The depth order can be controlled with the property TAB_DEPTH_ORDER.
	 * </p>
	 *
	 * @param value
	 *            number of pixels. A negative value reuslts in tabs overlapping
	 *            each other with the number of pixels.
	 * @return this TabbedPanelProperties
	 ...
	 * first tab will be the bottom most and the last tab the top most. Note
	 * that if a tab is highlighted, it will always be shown as the top most
	 * tab.
	 * </p>
	 *
	 * @param policy
	...
	/**
	 * <p>
	 * Sets the hover listener that will be triggered when the tabbed panel is
	 * hoverd by the mouse.
	 * </p>
	 *
	 * <p>
	 * The hovered tabbed panel will be the source of the hover event sent to
	 * the hover listener.
	 * </p>
	 *
	 * @param listener
	...
	/**
	 * <p>
	 * Gets the hover listener that will be triggered when the tabbed panel is
	 ...
	 *
	 * <p>
	 * The hover policy determines when the tabbed panel is considered hovered
	 * by the mouse and the hover listener is called. The default hover policy
	 * is NO_HOVERED_CHILD.
	 * </p>
	 *
	 * @param hoverPolicy
