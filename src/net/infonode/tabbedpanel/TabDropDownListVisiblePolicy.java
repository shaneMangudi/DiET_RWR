...
public final class TabDropDownListVisiblePolicy extends Enum {
	...
	/**
	 * Never drop down list policy. This means that no drop down list will be
	 * shown in the tabbed panel.
	 */
	public static final TabDropDownListVisiblePolicy NEVER = new TabDropDownListVisiblePolicy(0, "Never");

	/**
	 * More than one tab list policy. This means that a drop down list will be
	 * shown if there are more than one tab in the tabbed panel.
	 */
	public static final TabDropDownListVisiblePolicy MORE_THAN_ONE_TAB = new TabDropDownListVisiblePolicy(1,
			"More than One Tab");

	/**
	 * Tabs not visible list policy. This means that a drop down list will be
	 * shown when there are tabs are not entirely visible, i.e. scrolled out.
	 */
