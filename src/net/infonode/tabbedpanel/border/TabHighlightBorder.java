...
/**
 * TabHighlightBorder draws a 1 pixel wide highlight on the top and left side of
 * the tab. It will not draw highlight on the side towards a TabbedPanel's
 * content area if the border is constructed with open border.
 *
...
public class TabHighlightBorder implements Border, Serializable {
	...
	/**
	 * Constructs a TabHighlightBorder that acts as an empty border, i.e. no
	 * highlight is drawn but it will report the same insets as if the highlight
	 * was drawn
	 */
