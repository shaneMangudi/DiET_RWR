...
/**
 * TabLineBorder draws a 1 pixel wide line around a {@link Tab}. If tab spacing
 * in the tabbed panel is 0 then the border will only draw a single line between
 * two adjacent tabs.
 *
 * @author $Author: johan $
 ...
 *             {@link net.infonode.tabbedpanel.TabbedPanelProperties#TAB_SPACING}
 *             set to -1.
 */
public class TabLineBorder implements Border, Serializable {
	...
	/**
	 * Constructs a TabLineBorder that draws lines on three sides of the tab. No
	 * line will be drawn on the side towards the TabbedPanel's content area.
	 *
	 * @param color
	 *            the line color
	 */
	...
	/**
	 * Constructs a TabLineBorder that draws lines on three or four sides of the
	 * tab.
	 *
	 * @param color
	 *            the line color
	 * @param drawBottomLine
	 *            true if a line should be drawn on the side towards the tabbed
	 *            panel's content area, otherwise false
	 */
	...
	/**
	 * Constructs a TabLineBorder that draws lines on two, three or four sides
	 * of the tab.
	 *
	 * @param drawBottomLine
	 *            true if a line should be drawn on the side towards the tabbed
	 *            panel's content area, otherwise false
	 * @param drawTopLine
	 *            true if a line should be drawn on the side opposite to the
	...
	public TabLineBorder(Color color, boolean drawBottomLine, boolean drawTopLine) {
		this(ColorProviderUtil.getColorProvider(color, UIManagerColorProvider.TABBED_PANE_DARK_SHADOW), drawBottomLine,
				drawTopLine);
	}
	...
	/**
	 * Constructs a TabLineBorder that draws lines on three sides of the tab. No
	 * line will be drawn on the side towards the tabbed panel's content area.
	...
	/**
	 * Constructs a TabLineBorder that draws lines on three or four sides of the
	 * tab. The inner border will be drawn inside of this TabLineBorder.
	 *
	 * @param color
	 *            the line color
	 * @param innerBorder
