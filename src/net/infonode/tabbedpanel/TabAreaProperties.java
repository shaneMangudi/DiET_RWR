...
public class TabAreaProperties extends PropertyMapContainer {
	...
	public static final PropertyMapProperty COMPONENT_PROPERTIES = new PropertyMapProperty(PROPERTIES,
			"Component Properties", "Properties for tab area component.", ComponentProperties.PROPERTIES);
	...
	public static final PropertyMapProperty SHAPED_PANEL_PROPERTIES = new PropertyMapProperty(PROPERTIES,
			"Shaped Panel Properties", "Properties for shaped tab area.", ShapedPanelProperties.PROPERTIES);
	...
	/**
	 * Constructs a TabAreaProperties object with the given object as property
	 * storage
	 *
	 * @param object
	...
	/**
	 * Constructs a TabAreaProperties object that inherits its properties from
	 * the given TabAreaProperties object
	 *
	 * @param inheritFrom
	 *            TabAreaProperties object to inherit properties from
	 */
	...
	/**
	 * <p>
	 * Sets the hover listener that will be triggered when the tab area is
	 * hoverd by the mouse.
	 * </p>
	 *
	 * <p>
	 * The tabbed panel that the hovered tab area is part of will be the source
	 * of the hover event sent to the hover listener.
	 * </p>
	 *
	 * @param listener
	 *            the hover listener
	...
	/**
	 * Sets the tab area visible policy for the tab area, i.e. when the tab area
	 * is to be visible
	 *
	 * @param policy
	...
	/**
	 * Gets the tab area visible policy for the tab area, i.e. when the tab area
	 * is to be visible
	 *
