...
public class BlueHighlightTheme extends TabbedPanelTitledTabTheme {
	...
	public BlueHighlightTheme(Color backgroundColor) {
		tabProperties.getHighlightedProperties().getComponentProperties().setForegroundColor(Color.WHITE)
				.setBackgroundColor(backgroundColor).setBorder(new TabAreaLineBorder(Color.BLACK));
