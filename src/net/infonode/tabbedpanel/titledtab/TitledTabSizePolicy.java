...
/**
 * TitledTabSizePolicy defines how TitledTab should calculate its size. If the
 * different tab states results in different tab sizes, then TitledTab can
 * calculate the maximum size for the states and use that size for all the
 * states.
 *
...
public final class TitledTabSizePolicy extends Enum {
	 ...
	 * different tab sizes, then titled tab will calculate the maximum size for
	 * the states and use that size for all the states.
	 */
