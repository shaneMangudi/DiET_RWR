...
/**
 * TitledTabStateProperties holds all properties that are unique for a titled
 * tab state.
 *
...
public class TitledTabStateProperties extends PropertyMapContainer {
	 ...
	 * @see #getIcon
	 */
	public static final IconProperty ICON = new IconProperty(PROPERTIES, "Icon", "Icon",
	 ...
	 * @see #getText
	 */
	public static final StringProperty TEXT = new StringProperty(PROPERTIES, "Text", "Text",
			PropertyMapValueHandler.INSTANCE);
	 ...
	 * @see #getIconTextGap
	 */
	public static final IntegerProperty ICON_TEXT_GAP = IntegerProperty.createPositive(PROPERTIES, "Icon Text Gap",
			"Number of pixels between icon and text.", 2, PropertyMapValueHandler.INSTANCE);
	 ...
	 * @see #getToolTipText
	 */
	public static final StringProperty TOOL_TIP_TEXT = new StringProperty(PROPERTIES, "Tool Tip Text", "Tool tip text",
			PropertyMapValueHandler.INSTANCE);
	 ...
	 */
	public static final BooleanProperty TOOL_TIP_ENABLED = new BooleanProperty(PROPERTIES, "Tool Tip Enabled",
			"Tool tip enabled or disabled", PropertyMapValueHandler.INSTANCE);
	 ...
	 * @since ITP 1.1.0
	 */
	public static final BooleanProperty ICON_VISIBLE = new BooleanProperty(PROPERTIES, "Icon Visible",
			"Icon visible or not visible", PropertyMapValueHandler.INSTANCE);
	 ...
	 * @since ITP 1.1.0
	 */
	public static final BooleanProperty TEXT_VISIBLE = new BooleanProperty(PROPERTIES, "Text Visible",
			"Text visible or not visible", PropertyMapValueHandler.INSTANCE);
	...
	public static final BooleanProperty TITLE_COMPONENT_VISIBLE = new BooleanProperty(PROPERTIES,
			"Title Component Visible", "Title component visible or not visible", PropertyMapValueHandler.INSTANCE);
	...
	public static final AlignmentProperty HORIZONTAL_ALIGNMENT = new AlignmentProperty(PROPERTIES,
			"Horizontal Alignment", "Horizontal alignment for the icon and text.", PropertyMapValueHandler.INSTANCE,
	 ...
	 */
	public static final AlignmentProperty VERTICAL_ALIGNMENT = new AlignmentProperty(PROPERTIES, "Vertical Alignment",
			"Vertical alignment for the icon and text.", PropertyMapValueHandler.INSTANCE,
	...
	public static final AlignmentProperty ICON_TEXT_RELATIVE_ALIGNMENT = new AlignmentProperty(PROPERTIES,
			"Icon Text Relative Alignment", "Icon horizontal alignment relative to text.",
	...
	public static final IntegerProperty TEXT_TITLE_COMPONENT_GAP = IntegerProperty.createPositive(PROPERTIES,
			"Text Title Component Gap", "Number of pixels between text and title component.", 2,
			PropertyMapValueHandler.INSTANCE);
	...
	public static final AlignmentProperty TITLE_COMPONENT_TEXT_RELATIVE_ALIGNMENT = new AlignmentProperty(PROPERTIES,
			...
			"Title component horizontal alignment relative to text and icon.", PropertyMapValueHandler.INSTANCE,
	 ...
	 * @see #getDirection
	 */
	public static final DirectionProperty DIRECTION = new DirectionProperty(PROPERTIES, "Direction",
			"Direction for tab contents", PropertyMapValueHandler.INSTANCE);

	/**
	 * Tab component properties.
	 */
	public static final PropertyMapProperty COMPONENT_PROPERTIES = new PropertyMapProperty(PROPERTIES,
			"Component Properties", "Tab component properties.", ComponentProperties.PROPERTIES);
	...
	public static final PropertyMapProperty SHAPED_PANEL_PROPERTIES = new PropertyMapProperty(PROPERTIES,
			"Shaped Panel Properties", "Tab shaped panel properties.", ShapedPanelProperties.PROPERTIES);
	...
	/**
	 * Constructs a TitledTabStateProperties map with the give map as property
	 * storage
	 *
	 * @param map
	...
	/**
	 * Constructs a TitledTabStateProperties object that inherits its properties
	 * from the given TitledTabStateProperties object
	 *
	 * @param inheritFrom
	 ...
	 *
	 * @param alignment
	 *            text and icon horizontal alignment
	 * @return this TitledTabStateProperties
	 */
	 ...
	 * The text and icon will be rotated in the given direction and the title
	 * component will be moved.
	 *
	 * @param direction
	 *            direction
	 * @return this TitledTabStateProperties
	 ...
	 * The text and icon are rotated in the given direction and the title
	 * component will be moved.
	 *
	 * @return direction
	 */
