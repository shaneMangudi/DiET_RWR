...
public class TitledTabBorderSizePolicyProperty extends EnumProperty {
	 ...
	 */
	public TitledTabBorderSizePolicyProperty(PropertyGroup group, String name, String description,
			PropertyValueHandler valueStorage) {
		super(group, name, TitledTabBorderSizePolicy.class, description, valueStorage,
