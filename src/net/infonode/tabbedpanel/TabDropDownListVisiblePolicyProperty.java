...
public class TabDropDownListVisiblePolicyProperty extends EnumProperty {
	 ...
	 */
	public TabDropDownListVisiblePolicyProperty(PropertyGroup group, String name, String description,
			PropertyValueHandler valueStorage) {
		super(group, name, TabDropDownListVisiblePolicy.class, description, valueStorage,
