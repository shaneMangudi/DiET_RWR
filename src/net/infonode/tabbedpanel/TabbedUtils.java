...
public class TabbedUtils {
	 ...
	 *
	 * <p>
	 * <strong>Note:</strong> This is not a method for retrieving the tab for a
	 * specific content component. This method is only useful for finding the
	 * Tab for components that have been added to a Tab.
	 * </p>
	 *
	 * @param c
	 *            the component
	 ...
	 * @param c
	 *            the component
	 * @return the tabbed panel or null if component is not a child of any
	 *         tabbed panel
	 */
	...
	/**
	 * <p>
	 * Checks to see if hover is enabled i.e. if the AWTPermission
	 * "listenToAllAWTEvents" has been granted so that hover can be used.
	 * </p>
	 *
	 * <p>
	 * Note: This method is not meant to be used for permission checks, only as
	 * a convenience to check if hover is enabled or not.
	 * </p>
	 *
