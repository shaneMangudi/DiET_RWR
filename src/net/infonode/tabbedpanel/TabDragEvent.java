...
public class TabDragEvent extends TabEvent {
	 ...
	 *
	 * @param source
	 *            the Tab or TabbedPanel that is the source for this mouseEvent
	 * @param tab
	 *            the Tab that is being dragged
	 * @param point
	 *            the mouse coordinates relative to the Tab that is being
	 *            dragged
	 * @deprecated Use {@link #TabDragEvent(Object, java.awt.event.MouseEvent)}
	 *             instead.
	 */
	 ...
	 * @param mouseEvent
	 *            the mouse mouseEvent that triggered the drag, the event source
	 *            should be the tab and the event point should be relative to
	 *            the tab
	 * @since ITP 1.3.0
	 */
	...
	/**
	 * Returns the mouse event that triggered this drag. The event source is set
	 * to the tab and the event point is relative to the tab.
	 *
