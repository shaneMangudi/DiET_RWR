...
public class TabFactory {
	 ...
	 *            the content component for the tab
	 * @return the created TitledTab
	 */
	...
	/**
	 * Creates a TitledTab with a text, an icon, a title component and a content
	 * component
	 *
	 * @param text
	 *            the text
	 ...
	 *            the title component for the tab
	 * @return the created TitledTab
	 */
	public static TitledTab createTitledTab(String text, Icon icon, JComponent contentComponent,
	...
	/**
	 * Creates a TitledTab with a text, a different icon for each of the states,
	 * a title component and a content component
	 *
	 * @param text
	 *            the text
	 * @param icon
	 *            the icon for the normal state or null for no icon
	 * @param highlightedIcon
	 *            the icon for the highlighted state or null fo no icon
	 * @param disabledIcon
	 *            the icon for the disabled state or null for no icon
	 * @param contentComponent
	 *            the content component for the tab
	 * @param titleComponent
	 *            the title component for the tab
