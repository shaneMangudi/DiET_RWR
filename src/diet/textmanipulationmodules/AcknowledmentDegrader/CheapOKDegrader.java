...
public class CheapOKDegrader {
	public static boolean doesStringHaveOK(String s) {
		String haystack = " " + s + " ";
		if (haystack.indexOf(" ok ") > -1)
			return true;
		if (haystack.indexOf(" okay ") > -1)
			return true;
		if (haystack.indexOf(" oke ") > -1)
			return true;
		if (haystack.indexOf(" oky ") > -1)
			return true;
		if (haystack.indexOf(" k ") > -1)
			return true;
		if (haystack.indexOf(" kk ") > -1)
			return true;
		if (haystack.indexOf(" kay ") > -1)
			return true;
		if (haystack.indexOf(" mkay ") > -1)
			return true;
