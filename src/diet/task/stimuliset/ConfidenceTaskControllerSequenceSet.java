...
public class ConfidenceTaskControllerSequenceSet {
	...
	public static File loadFile() {
		String s = System.getProperty("user.dir") + File.separator + "experimentresources" + File.separator
				+ "confidence";
		...
		try {
			...
			if (line != 21) {
				CustomDialog.showDialog(
						"ERROR: there should be 21 lines in the file...only " + line + " have been detected");
				System.exit(-5);
			}
