...
public class DirectorTangramFrame extends TangramFrame {
	...
	protected int[] computeWidthHeightOfFrame() {
		...
		int w;
		w = Slot.clientWidth * DirectorTangramPanel.slotCount / 2
				+ DirectorTangramPanel.horiDistance * (DirectorTangramPanel.slotCount / 2 + 1);
	...
	public DirectorTangramFrame(TangramSequence seq, char whichDirector, Vector<SerialTangram> v, String tangramSetName)
			throws IOException {
		super();
