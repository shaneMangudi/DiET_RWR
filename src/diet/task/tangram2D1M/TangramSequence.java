...
/**
 * This is the generic super class of Self/Other and Collective/dyadic tangram
 * sequences. sequence is a array of strings where each member represents who
 * can see the tangram If A director A, if B director B and if AB, both
 * directors.
 * 
 * @author Arash
 */
