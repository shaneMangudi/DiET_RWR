...
public class MessageNextTangramPlaced extends MessageTask implements Serializable {
	...
	public MessageNextTangramPlaced(String email, String userName, int activeDropSlot, int sourceSlotID,
			int targetSlotID, boolean directorMoveOn, String tangramName) {
