...
public class MessageNewTangramsDirectorB extends MessageNewTangrams implements Serializable {
	...
	public TangramSequence sequence;// sequence determining directors'
									// complementary target tangrams

	public MessageNewTangramsDirectorB(String email, String userName, Vector<SerialTangram> v, String setName,
			TangramSequence sequence, String name) {
