...
public class SelfOtherTangramSequence extends TangramSequence {
	...
	public void setNewRandomSequence() {
		...
		interventions.add("AB");
		interventions.add("BA");
		interventions.add("BB");
		interventions.add("AA");
		...
		if (seq.charAt(11) == ' ') {
			if (seq.charAt(10) == 'B')
				seq = insertAt(seq, "A", 11);
			else
				seq = insertAt(seq, "B", 11);
		}
