...
public class ClientTangramGameComms extends ClientTaskEventHandler {
	...
	public void processTaskMove(MessageTask mt) {
		...
		if (mt instanceof MessageNewTangrams) {
			...
			// not being used at the moment. The game starts as soon as new
			// tangrams are recieved
	...
	public void tangramPlaced(int activeDropSlot, int sourceSlotID, int targetSlotID, boolean directorMoveOn,
			String tangramName) {
		MessageNextTangramPlaced mtp = new MessageNextTangramPlaced(cts.getEmail(), cts.getUsername(), activeDropSlot,
				sourceSlotID, targetSlotID, directorMoveOn, tangramName);
		cts.sendMessage(mtp);
	}
