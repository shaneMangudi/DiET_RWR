...
public class MatcherTangramFrame extends TangramFrame {
	...
	protected int[] computeWidthHeightOfFrame() {
		...
		int w;
		w = Slot.clientWidth * MatcherTangramPanel.emptySlotCount / 2
				+ MatcherTangramPanel.horiDistance * (MatcherTangramPanel.emptySlotCount / 2 + 1);
		int h = Slot.clientHeight * (2 + 3) + MatcherTangramPanel.vertiDistanceSourceTarget
				+ MatcherTangramPanel.vertiDistance * (4 + 2) + 50;
		int[] result = { w, h };
