...
public class MazeGameController3WAYUI {
	...
	JExperimentInProgressSuperPanel matcher2MF; // matcher2MF = new
												// JMazeFrame();
	...
	public void initializeJTabbedPane(final String directorName, final Vector directorMazes, final String matcher1Name,
			final Vector matcher1Mazes, final String matcher2Name, final Vector matcher2Mazes) {
		try {
