...
public class JMazeFrame extends JFrame {
	...
	private void jbInit() throws Exception {
		...
		// JMazeFrame_jButton1_actionAdapter(this));
...
class JMazeFrame_this_keyAdapter extends java.awt.event.KeyAdapter {
	JMazeFrame adaptee;
...
class JMazeFrame_this_windowStateAdapter implements java.awt.event.WindowStateListener {
	JMazeFrame adaptee;
...
class JMazeFrame_this_componentAdapter extends java.awt.event.ComponentAdapter {
	JMazeFrame adaptee;
