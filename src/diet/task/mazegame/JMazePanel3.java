...
public class JMazePanel3 extends JPanel {
	...
	protected void paintSquare(Graphics g, MazeSquare mz, Dimension position, Vector linksAllreadyDrawn) {
		...
		if (mz == maz.finish) {
			...
			g.fillRect((int) x0 + (widthIncrement * 1 / 8), (int) y0 + (heightIncrement * 1 / 8),
		...
		g.drawLine((int) x0 + (widthIncrement * 1 / 8), (int) y0 + (heightIncrement * 1 / 8),
				(int) x0 + (widthIncrement * 3 / 8), (int) y0 + (heightIncrement * 1 / 8));
		g.drawLine((int) x0 + (widthIncrement * 1 / 8), (int) y0 + (heightIncrement * 1 / 8),
				(int) x0 + (widthIncrement * 1 / 8), (int) y0 + (heightIncrement * 3 / 8));
		g.drawLine((int) x0 + (widthIncrement * 7 / 8), (int) y0 + (heightIncrement * 1 / 8),
				(int) x0 + (widthIncrement * 5 / 8), (int) y0 + (heightIncrement * 1 / 8));
		g.drawLine((int) x0 + (widthIncrement * 7 / 8), (int) y0 + (heightIncrement * 1 / 8),
				(int) x0 + (widthIncrement * 7 / 8), (int) y0 + (heightIncrement * 3 / 8));
		g.drawLine((int) x0 + (widthIncrement * 1 / 8), (int) y0 + (heightIncrement * 7 / 8),
				(int) x0 + (widthIncrement * 1 / 8), (int) y0 + (heightIncrement * 5 / 8));
		g.drawLine((int) x0 + (widthIncrement * 1 / 8), (int) y0 + (heightIncrement * 7 / 8),
				(int) x0 + (widthIncrement * 3 / 8), (int) y0 + (heightIncrement * 7 / 8));
		g.drawLine((int) x0 + (widthIncrement * 7 / 8), (int) y0 + (heightIncrement * 7 / 8),
				(int) x0 + (widthIncrement * 7 / 8), (int) y0 + (heightIncrement * 5 / 8));
		g.drawLine((int) x0 + (widthIncrement * 7 / 8), (int) y0 + (heightIncrement * 7 / 8),
				(int) x0 + (widthIncrement * 5 / 8), (int) y0 + (heightIncrement * 7 / 8));
		...
		if (mz.north != null) {
			...
			Color oldColor = g.getColor();
			g.setColor(this.mazeFigureColor);
			int width = (widthIncrement * 2) / 8;
			int height = (heightIncrement * 1) / 8;
			g.fillRect((int) x0 + (widthIncrement * 3 / 8), (int) y0, width, height);
			g.setColor(oldColor);
			///// NEW COMMANDS
			g.drawLine((int) x0 + (widthIncrement * 3 / 8), (int) y0 + (heightIncrement * 1 / 8),
					(int) x0 + (widthIncrement * 3 / 8), y0);
			g.drawLine((int) x0 + (widthIncrement * 5 / 8), (int) y0 + (heightIncrement * 1 / 8),
		...
		if (mz.east != null) {
			...
			Color oldColor = g.getColor();
			g.setColor(this.mazeFigureColor);
			int height = (heightIncrement * 2) / 8;
			int width = (widthIncrement * 1) / 8;
			g.fillRect((int) x0 + (widthIncrement * 7 / 8), (int) y0 + (heightIncrement * 3) / 8, width + 2, height);
			g.setColor(oldColor);
			///// NEW COMMANDS

			g.drawLine((int) x0 + (widthIncrement * 7 / 8), (int) y0 + (heightIncrement * 3 / 8),
					(int) x0 + widthIncrement, (int) y0 + (heightIncrement * 3 / 8));
			g.drawLine((int) x0 + (widthIncrement * 7 / 8), (int) y0 + (heightIncrement * 5 / 8),
		...
		if (mz.south != null) {
			...
			g.drawLine((int) x0 + (widthIncrement * 3 / 8), (int) y0 + (heightIncrement * 7 / 8),
					(int) x0 + (widthIncrement * 3 / 8), (int) y0 + (heightIncrement));
			g.drawLine((int) x0 + (widthIncrement * 5 / 8), (int) y0 + (heightIncrement * 7 / 8),
					(int) x0 + (widthIncrement * 5 / 8), (int) y0 + (heightIncrement));
		...
		if (mz.west != null) {
			...
			g.drawLine((int) x0 + (widthIncrement * 1 / 8), (int) y0 + (heightIncrement * 3 / 8), (int) x0,
					(int) y0 + (heightIncrement * 3 / 8));
			g.drawLine((int) x0 + (widthIncrement * 1 / 8), (int) y0 + (heightIncrement * 5 / 8), (int) x0,
					(int) y0 + (heightIncrement * 5 / 8));
		} else {
			g.drawLine((int) x0 + (widthIncrement * 1 / 8), (int) y0 + (heightIncrement * 3 / 8),
					(int) x0 + (widthIncrement * 1 / 8), (int) y0 + (heightIncrement * 5 / 8));
		}
		...
		if (mz.north != null && !linksAllreadyDrawn.contains(mz.north)) {
			...
			paintSquare(g, mz.north.getLinkedSquare(mz),
					new Dimension(position.width, position.height - heightIncrement), linksAllreadyDrawn);
			if (mz.north.isagate) {
				if (!maz.gatesOpen) {
					g.fillRect((int) x0 + (widthIncrement * 2 / 8), y0 - 3, (int) widthIncrement * 4 / 8, 6);
				} else {
					g.fillRect((int) x0 + (widthIncrement * 2 / 8), y0 - 3, (int) widthIncrement * 1 / 8, 6);
					g.fillRect((int) x0 + (widthIncrement * 5 / 8), y0 - 3, (int) widthIncrement * 1 / 8, 6);
					Color oldColor = g.getColor();
					g.setColor(Color.white);
					g.fillRect((int) x0 + (widthIncrement * 3 / 8), y0 - 3, (int) widthIncrement * 2 / 8, 6);
					g.setColor(oldColor);
		...
		if (mz.east != null && !linksAllreadyDrawn.contains(mz.east)) {
			...
			paintSquare(g, mz.east.getLinkedSquare(mz), new Dimension(position.width + widthIncrement, position.height),
					linksAllreadyDrawn);
			if (mz.east.isagate) {
				if (!maz.gatesOpen) {
					g.fillRect((int) x0 + widthIncrement - 3, (int) y0 + (heightIncrement * 2 / 8), (int) 6,
							(int) (heightIncrement * 4 / 8));
				} else {
					g.fillRect((int) x0 + widthIncrement - 3, (int) y0 + (heightIncrement * 2 / 8), (int) 6,
							(int) (heightIncrement * 1 / 8));
					g.fillRect((int) x0 + widthIncrement - 3, (int) y0 + (heightIncrement * 5 / 8), (int) 6,
							(int) (heightIncrement * 1 / 8));
					Color oldColor = g.getColor();
					g.setColor(Color.white);
					g.fillRect((int) x0 + widthIncrement - 3, (int) y0 + (heightIncrement * 3 / 8), 6,
							(heightIncrement * 2 / 8));
					g.setColor(oldColor);
		...
		if (mz.south != null && !linksAllreadyDrawn.contains(mz.south)) {
			...
			if (mz.south.isagate) {
				if (!maz.gatesOpen) {
					g.fillRect((int) x0 + (widthIncrement * 2 / 8), (int) y0 + heightIncrement - 3,
							(int) widthIncrement * 4 / 8, 6);
				} else {
					g.fillRect((int) x0 + (widthIncrement * 2 / 8), (int) y0 + heightIncrement - 3,
							(int) widthIncrement * 1 / 8, 6);
					g.fillRect((int) x0 + (widthIncrement * 5 / 8), (int) y0 + heightIncrement - 3,
							(int) widthIncrement * 1 / 8, 6);
					Color oldColor = g.getColor();
					g.setColor(Color.white);
					g.fillRect((int) x0 + (widthIncrement * 3 / 8), y0 - 3 + heightIncrement,
		...
		if (mz.west != null && !linksAllreadyDrawn.contains(mz.west)) {
			...
			paintSquare(g, mz.west.getLinkedSquare(mz), new Dimension(position.width - widthIncrement, position.height),
					linksAllreadyDrawn);
			if (mz.west.isagate) {
				if (!maz.gatesOpen) {
					g.fillRect((int) x0 - 3, (int) y0 + (heightIncrement * 2 / 8), (int) 6,
							(int) (heightIncrement * 4 / 8));
				} else {
					g.fillRect((int) x0 - 3, (int) y0 + (heightIncrement * 2 / 8), (int) 6,
							(int) (heightIncrement * 1 / 8));
					g.fillRect((int) x0 - 3, (int) y0 + (heightIncrement * 5 / 8), (int) 6,
							(int) (heightIncrement * 1 / 8));
					Color oldColor = g.getColor();
					g.setColor(Color.white);
					g.fillRect((int) x0 - 3, (int) y0 + (heightIncrement * 3 / 8), 6, (heightIncrement * 2 / 8));
					g.setColor(oldColor);
	...
	public void displayMazeDebugINFO() {
		...
		if (maz.current.east == null)
			System.err.println("CURRENT-EAST IS NULL");
		if (maz.current.south == null)
			System.err.println("CURRENT-SOUTH IS NULL");
		if (maz.current.west == null)
			System.err.println("CURRENT-WEST IS NULL");
		if (maz.current.north == null)
			System.err.println("CURRENT-NORTH IS NULL");

		System.err.println("GOALX: " + maz.finish.x);
		System.err.println("GOALY: " + maz.finish.y);

		if (maz.finish.east == null)
			System.err.println("FINISH: EAST IS NULL");
		if (maz.finish.south == null)
			System.err.println("FINISH: SOUTH IS NULL");
		if (maz.finish.west == null)
			System.err.println("FINISH: WEST IS NULL");
		if (maz.finish.north == null)
			System.err.println("FINISH: NORTH IS NULL");

		System.err.println("BEGINX: " + maz.begin.x);
		System.err.println("GOALY: " + maz.begin.y);

		if (maz.begin.east == null)
			System.err.println("BEGIN: EAST IS NULL");
		if (maz.begin.south == null)
			System.err.println("BEGIN: SOUTH IS NULL");
		if (maz.begin.west == null)
			System.err.println("BEGIN: WEST IS NULL");
		if (maz.begin.north == null)
			System.err.println("BEGIN: NORTH IS NULL");
	...
	public void moveCursorTo(Dimension d) {
		...
		cursorPos = new Dimension(cursorPos.width + widthIncrement * d.width,
				cursorPos.height + heightIncrement * d.height);
		System.out.println("JMAZEPANEL3 MOVED CURSOR!");

	}

	public Rectangle cursorToRect(Dimension c) {
		return new Rectangle(c.width, c.height, (int) widthIncrement / 6, (int) heightIncrement / 6);

	}

	protected void paintCursor(Graphics g) {
		this.reCalculateWidthsandSizes();
		g.fillOval((int) cursorPos.width - widthIncrement / 8, (int) cursorPos.height - heightIncrement / 8,
				(int) widthIncrement / 4, (int) heightIncrement / 4);
	...
	protected void paintComponent(Graphics g) {
		...
		int pixelborder = 0;
		try {
			if (jmf.jfgp.showBorder)
				pixelborder = jmf.jfgp.pixelborder;
		...
		if (jmf.cms == null) {
			...
			g.fillRect(0, 0, currentWidth, currentHeight);
			g.setColor(Color.black);
			g.drawString("Setting up ", (int) currentWidth / 2, (int) currentHeight / 2);
			g.setColor(oldColor);
			...
			g.fillRect(0, 0, currentWidth, currentHeight);
			g.setColor(Color.black);
			g.drawString(jmf.cms.getDisplayMessage(), (int) currentWidth / 2, (int) currentHeight / 2);
			g.setColor(oldColor);
		}
