...
public class MazeGameUtils {
				...
				for (int j = 0; j < subsubdirectories.length; j++) {
					...
					if (subsubdirectories[j].isDirectory()) {
						...
						for (int k = 0; k < vpa.size(); k++) {
							...
							String sOUTPUT = subdirectories[i].getName() + "|" + subsubdirectories[j].getName() + "|"
									+ k + "|" + "AAAAAA" + "|" + amazerefID + "|" + "A" + "\n";
							sOUTPUT = sOUTPUT + subdirectories[i].getName() + "|" + subsubdirectories[j].getName() + "|"
									+ k + "|" + "BBBBBB" + "|" + amazerefID + "|" + "B" + "\n";
							sOUTPUT = sOUTPUT + subdirectories[i].getName() + "|" + subsubdirectories[j].getName() + "|"
									+ k + "|" + "CCCCCC" + "|" + amazerefID + "|" + "A" + "\n";
							sOUTPUT = sOUTPUT + subdirectories[i].getName() + "|" + subsubdirectories[j].getName() + "|"
									+ k + "|" + "DDDDDD" + "|" + amazerefID + "|" + "B" + "\n";
							sOUTPUT = sOUTPUT + subdirectories[i].getName() + "|" + subsubdirectories[j].getName() + "|"
									+ k + "|" + "EEEEEE" + "|" + amazerefID + "|" + "A" + "\n";
							sOUTPUT = sOUTPUT + subdirectories[i].getName() + "|" + subsubdirectories[j].getName() + "|"
									+ k + "|" + "FFFFFF" + "|" + amazerefID + "|" + "B" + "\n";
							sOUTPUT = sOUTPUT + subdirectories[i].getName() + "|" + subsubdirectories[j].getName() + "|"
									+ k + "|" + "GGGGGG" + "|" + amazerefID + "|" + "A" + "\n";
							sOUTPUT = sOUTPUT + subdirectories[i].getName() + "|" + subsubdirectories[j].getName() + "|"
									+ k + "|" + "HHHHHH" + "|" + amazerefID + "|" + "B" + "\n";
	...
	public void establishReferencesets() {
		referenceSetA = readMazeFileAsStrings(
				"C:\\New folder\\UWA\\2014\\Maze Game Logs\\Maze Game Logs\\POD 1 DATA\\0002CCMAZE_DYADIC_MULTI_PARTICIPANTS_SEPARATEDYADS\\cl1Mazes.txt");
		referenceSetB = readMazeFileAsStrings(
				"C:\\New folder\\UWA\\2014\\Maze Game Logs\\Maze Game Logs\\POD 1 DATA\\0002CCMAZE_DYADIC_MULTI_PARTICIPANTS_SEPARATEDYADS\\cl2Mazes.txt");
	}
