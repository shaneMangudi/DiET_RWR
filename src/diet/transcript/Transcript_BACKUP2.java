 ...
 * @author gj
 */
public class Transcript_BACKUP2 {
	...
	public Transcript_BACKUP2(Participant p, Conversation c) {
		this.c = c;
		this.p = p;
		jtf = new JTranscriptFrame2(null, c, p);
	...
	private void saveData(String sTurntype, String sEDITS, String selfFULLTURN, String otherFULLTURN,
		...
		if (sEDITS.length() > 0) {
			...
			String textToSave = sTurntype + DefaultConversationController.config.recordeddata_CSVSeparator + sEDITS
					...
					+ DefaultConversationController.config.recordeddata_CSVSeparator + otherTEXTINWIDOW1;
