...
public class JOutputPanels extends JPanel {
	...
	public JOutputPanels() {
		...
		//// TitledTab tab1 = new TitledTab("Templates & Settings", null, new
		// JTextArea(),null,15);
		//// TitledTab tab2 = new TitledTab("Experiment WOT:FRAG", null, new
		// JTextArea(), null,15);
		//// TitledTab tab3 = new TitledTab("Experiment Shortest common turn",
		// null, new JTextArea(), null,15);
		//// tabbedPanel.addTab(tab1);
		//// tabbedPanel.addTab(tab2);
		//// tabbedPanel.addTab(tab3);

		/*
		 * TabbedPanelTitledTabTheme[] themes = new
		 * TabbedPanelTitledTabTheme[]{new DefaultTheme(), new
		 * LookAndFeelTheme(), new ClassicTheme(), new BlueHighlightTheme(), new
		 * SmallFlatTheme(), new GradientTheme(), new GradientTheme(true, true),
		 * new ShapedGradientTheme(), new ShapedGradientTheme( 0f, 0f, new
		 * FixedColorProvider( new Color(150, 150, 150)), null) { public String
		 * getName() { return super.getName() + " Flat with no Slopes"; } }};
		 * 
		 */
		//// TabbedPanelTitledTabTheme theme = themes[8];

		//// TitledTabProperties titledTabProperties = new
		//// TitledTabProperties();
		...
		// TitledTab tab4 = new TitledTab("Experiment Shortest common turn",
		///// null, new JTextArea(), null,15);
		...
		outputTextCreatingPanelIfNecessary("Main",
				"The clients will need to know the internet address of the server.\nBelow should be a list of all "
	...
	private String showIPAddress() {
		...
		return ipaddresses
				+ "If none of the above internet addresses work, please check your firewall settings and/or use ipconfig (Windows) or ifconfig (apple)\n";
	}
	...
	private synchronized void createNewOutputPanelAndAppendText(final String name, final String text) {
		...
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				...
				jtp.addTab(name, jo);
				// System.out.println("-------------------ADDING PANELNAME
				// "+name);
