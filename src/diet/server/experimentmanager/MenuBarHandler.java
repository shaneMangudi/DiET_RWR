...
public class MenuBarHandler implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (s.equalsIgnoreCase("Collate multiple experiments")) {
			...
			try {
				emui.displayONOFFDynamicTextDisplayOfConversationCorrespondingToTabbedPane(
						jltp.getSelectedTab().getContentComponent());
			} catch (Exception e2) {
			}
			...
			String text = DefaultConversationController.config.about_info + "\n\n" + "Version: "
					+ DefaultConversationController.config.about_softwareversion;
			...
			try {
				...
				File fuserdir = new File(
						userdir + File.separator + "data" + File.separator + "Saved experimental data");
	...
	public void buildMenu() {
		...
		menuItem = new JMenuItem("Open data folder");
		menuItem.addActionListener(this);
		menu.add(menuItem);

		// menuItem = new JMenuItem("Create settings for client on USB stick");
		// menuItem.addActionListener(this);
		// menu.add(menuItem);

		// menuItem = new JMenuItem("Open previous data for replay");
		// menuItem.addActionListener(this);
		// menu.add(menuItem);
		...
		js = new JSeparator();
		menu.add(js);
		menuItem = new JCheckBoxMenuItem("Auto-scroll conversation", true);
		menuItem.addActionListener(this);
		menu.add(menuItem);
		menuItem = new JCheckBoxMenuItem("Auto-scroll text in Output windows", true);
		menuItem.addActionListener(this);
		menu.add(menuItem);

		menu = new JMenu("Utils");
		menuBar.add(menu);
		menuItem = new JMenuItem("Collate multiple experiments");
		menuItem.addActionListener(this);
		menu.add(menuItem);
		menuItem = new JMenuItem("Design mazes");
		menuItem.addActionListener(this);
		menu.add(menuItem);
		// menuBar.add(menu);
		...
		JMenu jmen = new JMenu("Help");
		menu.add(jmen);

		// JMenuItem menuItem2 = new JMenuItem("How urgent is it?");
		// menuItem.addActionListener(this);
		// jmen.add(menuItem2);
		...
		JMenuItem jmenn2itcntwaitcontact = new JMenuItem("Please call this number: "
				+ DefaultConversationController.config.about_tcontact + "..if I can I will answer immediately!");
		jmenn2itcntwait.add(jmenn2itcntwaitcontact);

		JMenuItem jmenn2itcnwaitcontact = new JMenuItem(
				"Please email " + DefaultConversationController.config.about_econtact);
		jmenn2itcnwait.add(jmenn2itcnwaitcontact);

		// JMenuItem menuItem3 = new JMenuItem("It can wait 12 hours");
		// menuItem3.addActionListener(this);
		// menuItem2.add(menuItem3);

		// JMenuItem menuItem4 = new JMenuItem("Urgent panic!");
