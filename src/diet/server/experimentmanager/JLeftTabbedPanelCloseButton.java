...
public class JLeftTabbedPanelCloseButton extends JButton implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		Object[] possibilities = { "keep experiment running", "stop experiment and keep window",
				"stop experiment and discard window", "stop experiment and keep window and stop clients",
				"stop experiment and discard window and stop clients", };
		String s = (String) JOptionPane.showInputDialog(null, "What do you want to do with current experiment?",
				"Experiment management", JOptionPane.PLAIN_MESSAGE, null, possibilities, "keep experiment running");
		if (s == null)
			return;
