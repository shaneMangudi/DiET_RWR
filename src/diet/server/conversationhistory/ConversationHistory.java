...
public class ConversationHistory implements Serializable {
	...
	public ConversationHistory(Conversation c, String nameOfConversation, IntelligentIO cIO) {
		this.convIO = cIO;
	 ...
	 * @param turnNumber
	 */
	public synchronized void saveMessageRelayedToOthers(String dtype, long timeOnClientOfStartTyping,
			long timeOnClientOfSending, long timeOnServerOfReceipt, String senderID, String senderUsername,
			String apparentSenderUsername, String text, Vector recipientsNames, boolean wasBlocked, Vector keyPresses,
			Vector documentUpdates, Vector clientInterfaceEvents, Vector additionalValues, boolean dummy) {
		...
		NormalTurnProducedByParticipant tbp = new NormalTurnProducedByParticipant(this, dtype,
				timeOnClientOfStartTyping, timeOnClientOfSending, timeOnServerOfReceipt, senderID, sender,
				apparentSender, text, recipients, wasBlocked, keyPresses, documentUpdates, clientInterfaceEvents,
				additionalValues);
	...
	public synchronized void saveInterceptedNonRelayedMessage(String dtype, long timeOnClientOfStartTyping,
			long timeOnClientOfSending, long timeOnServerOfReceipt, String senderID, String senderUsername,
			String apparentSenderUsername, String text, Vector recipientsNames, boolean wasBlocked, Vector keyPresses,
			Vector documentUpdates, Vector clientInterfaceEvents, Vector additionalValues, boolean dummy) {
		...
		diet.server.conversationhistory.turn.NormallTurnProducedByParticipantInterceptedByServer tbp = new NormallTurnProducedByParticipantInterceptedByServer(
				this, dtype, timeOnClientOfStartTyping, timeOnClientOfSending, timeOnServerOfReceipt, senderID, sender,
				apparentSender, text, recipients, wasBlocked, keyPresses, documentUpdates, clientInterfaceEvents,
				additionalValues);
	...
	public synchronized void saveArtificialMessageCreatedByServer(String dtype, long timeOnServerOfSending,
			String apparentSenderUsername, String text, Vector recipientsNames, Vector additionalValues,
			boolean dummy) {

		// mct.getStartOfTypingOnClient(),
		// mct.getTimeOfSending().getTime(),mct.getTimeOfReceipt().getTime()
		...
		ArtificialTurnProducedByServer atpbs = new ArtificialTurnProducedByServer(this, dtype, timeOnServerOfSending,
				sender, "server", apparentSender, text, recipients, additionalValues);
	...
	public synchronized void saveDataAsRowInSpreadsheetOfTurns(String subdialogueID, String dataType,
			long timeOnClientOfStartTyping, long timeOnClientOfSending, long timeOnServerOfReceipt, String senderID,
			String senderUsername, String apparentSenderUsername, String text, Vector recipientsNames,
			boolean wasBlocked, Vector keyPresses, Vector documentUpdates, Vector additionalValues, boolean dummy) {

		// ----------------------------------------------------------------------------

		Turn t = new DataToBeSaved(this, subdialogueID, dataType, timeOnClientOfStartTyping, timeOnClientOfSending,
				timeOnServerOfReceipt, senderID, senderUsername, apparentSenderUsername, text, recipientsNames,
				wasBlocked, keyPresses, documentUpdates, additionalValues);
