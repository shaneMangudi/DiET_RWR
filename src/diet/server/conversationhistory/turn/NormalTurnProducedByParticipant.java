...
public class NormalTurnProducedByParticipant extends Turn implements Serializable {
	...
	private Vector clientinterfaceevents = new Vector();

	public NormalTurnProducedByParticipant(ConversationHistory cH, String subdialogueID, long timeOnClientOfStartTyping,
			long timeOnClientOfSending, long timeOnServerOfReceipt, String senderID, Conversant sender,
			Conversant apparentSender, String text, Vector recipients, boolean wasBlocked, Vector keyPresses,
			Vector documentUpdates, Vector clientinterfaceevents, Vector additionalStrings) {
