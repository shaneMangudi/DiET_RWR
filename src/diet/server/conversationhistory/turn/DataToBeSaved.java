...
public class DataToBeSaved extends Turn implements Serializable {
	...
	public DataToBeSaved(ConversationHistory cH, String subdialogueID, String dataType, long timeOnClientOfStartTyping,
			long timeOnClientOfSending, long timeOnServerOfRELAY, String senderID, String senderUsername,
			String apparentSenderUsername, String dataValue, Vector recipients, boolean wasBlocked, Vector keyPresses,
			Vector documentUpdates, Vector additionalStrings) {
