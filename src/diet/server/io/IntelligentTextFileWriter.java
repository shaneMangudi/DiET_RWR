...
public class IntelligentTextFileWriter extends Thread {
	...
	private void reestablishFile() {
		...
		while (!wasSuccessfulReestablishing) {
			...
			try {
				this.textOut = new BufferedWriter(
	...
	public static void main(String[] args) {
		// IntelligentTextFileWriter itfw = new IntelligentTextFileWriter(new
		// File("debugoutput.txt"));

	}

	// static int debugCounter =0;
	// static IntelligentTextFileWriter itfw = new IntelligentTextFileWriter(new
	// File("debugoutput.txt"));
