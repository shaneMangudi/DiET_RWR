...
public class ClassLoad {
	 ...
	 * CustomDialog.showDialog("MYCLASSNAME"+myClassName); URL urlJar =
	 * this.getClass().getClassLoader().getSystemResource(myClassName); String
	 * urlStr="NOTSET"; try{ urlStr = urlJar.toString();
	 * CustomDialog.showDialog("MYURL"+urlJar); }catch(Exception e){
	 * CustomDialog.showDialog(e.getMessage()+"--"+e.getLocalizedMessage()+"--"+
	 * e.toString()); System.exit(-45); } int from = "jar:file:".length(); int
	 * to = urlStr.indexOf("!/"); CustomDialog.showModeLessDialog(
	 * "MYCLASSNAME IS: "+myClassName+"------"+"MYURL IS: "+urlStr, 10000);
	 * CustomDialog.showDialog(""); System.exit(-45);
	 * 
	 * }
	 */
	...
	public static Vector getConversationControllersOLD() {
		...
		// File f4 = new
		// File(f3.getAbsoluteFile()+File.separator+"dist"+File.separator);
		// File f5 = new
		// File(f3.getAbsoluteFile()+File.separator+"dist"+File.separator+"chattool.jar");
		...
		// File f8DEBUG = new
		// File(f6.getAbsoluteFile()+File.separator+"chattool.jar");
		// List listDEBUG = getClasseNamesInPackage(f8DEBUG.getAbsolutePath(),
		// "diet.server.ConversationController");
		...
		/// is.."+f6.getName()+"........."+f7.getAbsolutePath());
