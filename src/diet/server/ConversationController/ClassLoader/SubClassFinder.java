...
/**
 * Will scan and list all the subclasses of a given class or Interface, Its even
 * search for classes in a jar file too..
 * <li>Get a list of all class names that exist on the class path</li>
 * <li>Load each class and test to see if</li> While scanning all the classes it
...
public class SubClassFinder {
	...
	private final Vector<Class<?>> findSubclasses(URL location, String packageName, Class<?> superClass) {
		if (!packageName.contains("ConversationController"))
			return new Vector();
	...
	public static void main(String[] args) {
		...
		if (args.length == 1) {
			...
			System.out.println("Usage: java SubClassFinder <fully.qualified.superclass.name>");
			return;
		}
