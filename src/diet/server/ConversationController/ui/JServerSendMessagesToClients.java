...
public class JServerSendMessagesToClients extends javax.swing.JFrame {
	 ...
	 */
	public JServerSendMessagesToClients(DefaultConversationController cC, String defaultMessagetoParticipants,
			String defaultURL) {
		initComponents();
		// this.setTitle("SERVER:
		// "+cC.getC().getExpManager().getPortNumberListening());
		this.cC = cC;
	...
	private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
		...
		try {
			Vector allParticipants = cC.getConversation().getParticipants().getAllParticipants();

			for (int i = 0; i < allParticipants.size(); i++) {
				Participant p = (Participant) allParticipants.elementAt(i);
				String[] options = { "OK" };
				cC.getConversation().showPopupOnClientQueryInfo("", p, this.jTextPane1.getText(), options,
						this.jTextPane1.getText(), 0, "");
			}
	...
	private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton2ActionPerformed
		...
		try {
			...
			for (int i = 0; i < allParticipants.size(); i++) {
				Participant p = (Participant) allParticipants.elementAt(i);
				String[] options = { "OK" };
				cC.getConversation().openClientBrowserToWebpage(p, webaddress);
			}
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(JServerSendMessagesToClients.class.getName())
