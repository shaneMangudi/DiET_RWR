...
public class CustomDialog {
	...
	public static int getInteger(String prompt, int defaultValue) {
		...
		while (!isInteger) {
			String s = (String) JOptionPane.showInputDialog(null, prompt, "Type in a number", JOptionPane.PLAIN_MESSAGE,
	...
	public static double getDouble(String prompt, double min, double maxExclusive, double defaultValue) {
		...
		while (!isPermitted) {
			String s = (String) JOptionPane.showInputDialog(null, prompt,
			...
			try {
				...
				prompt = prompt + "\nPlease make sure it's between " + min + " (inclusive)  and " + maxExclusive
						+ " (exclusive)";
			}
	...
	public static String getString(String prompt, String defaultValue) {
		boolean isInteger = false;
		while (!isInteger) {
			String s = (String) JOptionPane.showInputDialog(null, prompt, "", JOptionPane.PLAIN_MESSAGE, null, null,
					"" + defaultValue);
			try {
				return s;
	...
	public static String showComboBoxDialog(String title, String prompt, Object[] possibilities,
			boolean forceNonNullChoice) {

		String s = (String) JOptionPane.showInputDialog(null, prompt, title, JOptionPane.PLAIN_MESSAGE, null,
				possibilities, "01");
		while (forceNonNullChoice && (s == null || s.equals(""))) {
			CustomDialog.showDialog("ERROR\nYou must make a choice. You can't press cancel!");
			s = (String) JOptionPane.showInputDialog(null, "Choose a randomized maze set:", "Please choose a maze set",
					JOptionPane.PLAIN_MESSAGE, null, possibilities, "01");
		}
	...
	public static String show3OptionDialog(String[] threeOptionsOnButtons, String questionprompt,
			String titleOfWindow) {

		int n = JOptionPane.showOptionDialog(null, questionprompt, titleOfWindow, JOptionPane.YES_NO_CANCEL_OPTION,
				JOptionPane.QUESTION_MESSAGE, null, threeOptionsOnButtons, threeOptionsOnButtons[0]);
	...
	public static String show2OptionDialog(String[] twoOptionsOnButtons, String questionprompt, String titleOfWindow) {
		...
		int n = JOptionPane.showOptionDialog(null, questionprompt, titleOfWindow, JOptionPane.YES_NO_OPTION,
				JOptionPane.QUESTION_MESSAGE, null, twoOptionsOnButtons, twoOptionsOnButtons[0]);
		...
		if (retrieval == JFileChooser.APPROVE_OPTION) {
			try {
				...
				Writer out = new BufferedWriter(
						new OutputStreamWriter(new FileOutputStream(chooser.getSelectedFile() + "_UTF8.txt"), "UTF-8"));
				out.write(contents);
				out.close();
