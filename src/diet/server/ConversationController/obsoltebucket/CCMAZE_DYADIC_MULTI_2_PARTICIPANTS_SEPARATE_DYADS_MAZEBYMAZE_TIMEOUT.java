...
public class CCMAZE_DYADIC_MULTI_2_PARTICIPANTS_SEPARATE_DYADS_MAZEBYMAZE_TIMEOUT extends DefaultConversationController
	...
	public CCMAZE_DYADIC_MULTI_2_PARTICIPANTS_SEPARATE_DYADS_MAZEBYMAZE_TIMEOUT(Conversation c) {
		super(c);
	...
	public synchronized void participantJoinedConversation(final Participant p) {
		...
		if (!added) {
			...
			Conversation.printWSln("Main", "Didn't add " + p.getParticipantID());
		}
		Conversation.printWSlnLog("Main", "------------");
		Conversation.printWSlnLog("Main",
