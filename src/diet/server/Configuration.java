...
public class Configuration {
	...
	// public static CyclicRandomParticipantIDGeneratorGROOP
	// autologinParticipantIDGenerator = new
	// CyclicRandomParticipantIDGeneratorGROOP();
	public boolean debug_debugTime = true;
	public long debug_logging_of_OverrunTime_threshold = 500; // time in
																// milliseconds

	/*
	 * Below are experiment parameters. It is (strongly!) advisable not to edit
	 * them here, but instead override in a subclass These parameters are
	 * intended primarily for initializing the experiment, not for changing the
	 * chat tool behaviour while the experiment is running There is no guarantee
	 * that changing these parameters during an experiment will have the desired
	 * effect! Please write custom code instead.
	 * 
	 */
	...
	public int client_TextEntryWindow_istypingtimeout = 1000;

	public int client_numberOfWindows = 1;
	public int client_turnDisplayLimit = 0;

	// These settings below are the default - however they might be overriden by
	// custom implementations of the StlyeManager
	...
	public String client_font_OTHER_fontfamily = "Monospace";
	public int client_font_OTHER_size = 22;
	public boolean client_font_OTHER_isbold = false;
	public boolean client_font_OTHER_isitalic = false;
	// public Color client_font_OTHER_foregroundcolour = Color.BLUE;
	public int[] client_font_OTHER_foregroundcolour_rgb = { 0, 0, 255 };
	...
	public String debug_fakeTypingByClientSTARTTrigger = "/startdebug"; // This
																		...
																		// typing
																		// events"
	public String debug_fakeTypingByClientSTOPTrigger = "/stopdebug"; // This is
																		// used
																		// by
																		// the
																		// client
	...
	/// Be very! vareful modifying this. If it is modified without checking all
	/// its uses - can lead to crash!
	static public String[] recordeddata_mainoutputfileheader_HEADER = { "ExperimentID", "ServerTimestampOfSavingToFile",
			"SubdialogueID", "Turntype", "SernderID", "SenderUsername", "ApparentSender", "Text", "Recipient(s)",
			"NoOfDocumentDeletes", "NoOfKeypressDeletes", "ClientTimestampONSET", "ClientTimestampENTER",
			"ServerTimestampOfReceiptAndOrSending", "TextAsformulatedTIMING", "TextAsFormulatedLOGSPACE" };
	...
	static public String about_tcontact = "+" + "31" + "XXX" + "YYY" + "ZZZ";
	...
	static public double about_softwareversion = 3.99;
	static final public String about_info = "This is the 4th incarnation of the chat tool. It grew out of the ROSSINI project (P.G.T. Healey, Queen Mary University)\n"
