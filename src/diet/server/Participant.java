...
public class Participant {
	...
	public void sendMessage(Message m) {
		...
		if (DefaultConversationController.config.debug_debugMESSAGEBLOCKAGE)
			System.out.println("SINP " + getUsername());
		if (participantConnection != null)
			participantConnection.send(m);
		if (DefaultConversationController.config.debug_debugMESSAGEBLOCKAGE)
			System.out.println("SINQ" + getUsername());
	...
	/**
	 * Returns the content of the participant's text entry window (before they
	 * presss ENTER or SEND)
	 * 
	 * @return whether participant has typed
	 */
	public String getTextEntryWindow() {
		if (this.participantConnection != null)
			return this.participantConnection.getTextEntryWindow();
		return "";
	}

	/**
	 *
	 * @return whether participant is associated with ParticipantConnection that
	...
	public boolean isConnected() {
		if (this.participantConnection == null) {
			...
			return this.participantConnection.isConnected();
	}
