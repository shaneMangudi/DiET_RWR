...
public class JParticipantsPanel extends JPanel {
	...
	public JParticipantsPanelSouth jpps;// = new
										// JParticipantsPanelSouth(cH.getConversation());

	public JParticipantsPanel(ConversationHistory cH) {
		this.cH = cH;
		jpps = new JParticipantsPanelSouth(cH.getConversation(), this);
		// this.add(new JLabel("THIS"));
		// this.add(new JButton("THIS"));
		this.setLayout(new BorderLayout());
		jpt = new JParticipantsTable(cH);
