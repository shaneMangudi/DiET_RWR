...
public class JClientEnterFieldsFrame extends JFrame {
	...
	public void displayText(String username, String text) {
		/*
		 * for(int i=0;i<panels.size();i++){ JClientEnterFieldPanel jefp =
		 * (JClientEnterFieldPanel)panels.elementAt(i);
		 * if(jefp.getName().equalsIgnoreCase(username)){ jefp.setText(text);
		 * return; } }
		 */
		final String username2 = username;
