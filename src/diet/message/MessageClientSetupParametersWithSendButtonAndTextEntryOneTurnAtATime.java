...
public class MessageClientSetupParametersWithSendButtonAndTextEntryOneTurnAtATime extends MessageClientSetupParameters
	...
	public MessageClientSetupParametersWithSendButtonAndTextEntryOneTurnAtATime(String servername, String servername2,
			int numberOfRows, int numberOfColumns, boolean alignmentIsVertical, int numberOfWindows,
			int windowOfOwnText, boolean windowIsEnabled, boolean participantHasStatusWindow, String statusDisplay,
			boolean statusIsInRed, int rowsOfTextEntryArea, int numberOfTurnsDisplayed, boolean isScrollAble) {
