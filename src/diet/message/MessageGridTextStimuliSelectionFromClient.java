...
public class MessageGridTextStimuliSelectionFromClient extends MessageTask {
	...
	public MessageGridTextStimuliSelectionFromClient(String email, String userName, long serverIDD, int position,
			String name, long timeOnClientOfSelection, Color innerColor, Color innerMostColor) {
