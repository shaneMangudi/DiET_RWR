...
public class MessageSubliminalStimuliDisplaySlideShow extends Message {
	...
	public MessageSubliminalStimuliDisplaySlideShow(String text, Color textcolour, String nameOfBackgroundPanel,
			int positionX, int positionY, long lengthOfTime) {
		super("server", "server");
		this.text = text;
		this.positionX = positionX;
		this.positionY = positionY;
		this.nameOfBackgroundPanel = nameOfBackgroundPanel;
		if (nameOfBackgroundPanel == null)
			nameOfBackgroundPanel = "";
