...
public class MessageSubliminalStimuliChangeImage extends Message {
	...
	public MessageSubliminalStimuliChangeImage(long fixation1time, long stimulus1time, long blankscreen1time,
			long fixation2time, long stimulus2time, long blankscreen2time, String stimulus1ID, String stimulus2ID) {
		super("server", "server");
