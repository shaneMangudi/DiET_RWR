...
public class MessagePopupResponseFromClient extends Message implements Serializable {
	...
	public MessagePopupResponseFromClient(String popupIDNeededForFeedBackBackToServer, String senderID, String username,
			String question, String[] options, String title, int selection, long timeOnClientOfDisplay,
			long timeOnClientTimeOfChoice) {
