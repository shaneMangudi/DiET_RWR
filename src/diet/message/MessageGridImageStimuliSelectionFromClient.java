...
public class MessageGridImageStimuliSelectionFromClient extends MessageTask {
	...
	public MessageGridImageStimuliSelectionFromClient(String email, String userName, long serverIDD, int position,
			String nameOfImage, long timeOnClientOfSelection) {
