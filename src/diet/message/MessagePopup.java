...
public class MessagePopup extends Message implements Serializable {
	...
	public MessagePopup(String popupIDNeededForFeedBackBackToServer, String senderID, String username, String question,
			String[] options, String title, int selection) {
