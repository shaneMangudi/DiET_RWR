...
public class MessageClientLogon extends Message implements Serializable {
	...
	public MessageClientLogon(String email, String username, double scc, InetAddress ina, int inPort,
			InetAddress local_ina, int local_port, SocketAddress socketAddress) {
