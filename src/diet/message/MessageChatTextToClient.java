...
public class MessageChatTextToClient extends Message implements Serializable {
	...
	public MessageChatTextToClient(String idToConfirm, String email, String username, String t, int windowNumber,
			boolean prefixUsername, MutableAttributeSet styleattributes) {
