...
public class JChatFrameMultipleWindowsWithSendButtonWidthByHeightDocument extends DefaultStyledDocument {
	...
	public JChatFrameMultipleWindowsWithSendButtonWidthByHeightDocument(
			JChatFrameMultipleWindowsWithSendButtonWidthByHeight jcfmwwsbwbh) {
	...
	public void insertString(int offs, String str, AttributeSet a) throws BadLocationException {
		...
		if (super.getLength() + str.length() > this.jcfmwwsbwbh.maxcharlength)
			return;
		...
		jcfmwwsbwbh.getClientEventHandler().reportInterfaceEvent(
				ClientInterfaceEventTracker.textentryfield_insertstring, timeOfDisplay, av1, av2, av5);
	}

	@Override
	public void remove(int offs, int len) throws BadLocationException {
		if (!this.permitDeletes)
			return;
	...
	public void remove(int offs, int len, boolean isAutoClearAfterSendingMessage) throws BadLocationException {
		...
		if (!isAutoClearAfterSendingMessage)
			jcfmwwsbwbh.getClientEventHandler().reportInterfaceEvent(
					ClientInterfaceEventTracker.textentryfield_removestring, timeOfDisplay, av1, av2, av3, av5);
	}
	...
	public void replace(int offset, int length, String text, AttributeSet attrs) throws BadLocationException {
		...
		if (totallengthOfProposedChanges > totallengthOfDocument + this.jcfmwwsbwbh.maxcharlength)
			return;
		...
		try {
			...
			if (textBeingDeleted != null && !textBeingDeleted.equals("")) {
				...
				jcfmwwsbwbh.getClientEventHandler().reportInterfaceEvent(
						ClientInterfaceEventTracker.textentryfield_replacestring, timeOfDisplay, av1, av2, av4, av5,
						av6);
