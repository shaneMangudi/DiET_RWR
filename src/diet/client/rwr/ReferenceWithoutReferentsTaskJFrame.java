	...
	public void requestFinalInput() {
		...
		while (true) {
			input = (String) JOptionPane.showInputDialog(this,
					"Thanks for playing! We have now disconnected the chat for a final question:\n\n"
				  + "What do you think were the objects our game was about?\n"
				  + "Try to describe as many of the objects from the game as you can remember.\n\n",
					"Success", JOptionPane.QUESTION_MESSAGE, null, null, input);
			int selectedOption = JOptionPane.showConfirmDialog(this, "Your response was: \n" + input + "",
					"Confirm your input.", YES_NO_OPTION, INFORMATION_MESSAGE);
