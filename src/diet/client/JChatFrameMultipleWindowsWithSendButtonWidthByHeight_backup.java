...
public class JChatFrameMultipleWindowsWithSendButtonWidthByHeight_backup extends JChatFrame {
	...
	public JChatFrameMultipleWindowsWithSendButtonWidthByHeight_backup(ClientEventHandler clevh, int numberOfWindows,
				...
				try {
					...
					if (colorForeground != jprogressbarcolor) {
						defaults.put("ProgressBar[Enabled].foregroundPainter",
								new JProgressBarFillPainter(colorForeground));
	...
	public class DoAppendTextWithCaretCheck implements Runnable {
		...
		public DoAppendTextWithCaretCheck(JChatFrameMultipleWindowsWithSendButtonWidthByHeight_backup jcfmwwsbw,
				JTextPane jtp, JScrollPane jsp, int windowNumber, String idTOCONFIRM, String prefix, boolean showPrefix,
				String text, Object attributeset, boolean bySelf) {
			this.jtp = jtp;
			this.jsp = jsp;
			this.text = text;
