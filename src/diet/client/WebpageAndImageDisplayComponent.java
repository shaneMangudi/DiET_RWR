...
public class WebpageAndImageDisplayComponent {
	...
	public WebpageAndImageDisplayComponent(final String header, final String url, final int width, final int height,
			final boolean vScrollBar, final boolean progressBar, final boolean forceCourierFont) {
		...
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					// Boolean.TRUE);
					if (forceCourierFont)
						editorPane.setFont(new Font("Courier New", Font.PLAIN, 15));// System.exit(-5);
