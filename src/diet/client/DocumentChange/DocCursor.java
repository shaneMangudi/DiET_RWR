...
public class DocCursor extends DocChange {
	...
	public DocCursor(String sender, String apparentSender, String recipient, int cursorstart, int cursorfinish,
	...
	public DocCursor returnCopy() {
		DocCursor dc = new DocCursor(sender, apparentSender, recipient, cursorstart, cursorfinish, elementString,
				elementStart, elementFinish);
