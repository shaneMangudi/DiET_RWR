 ...
 * 
 * <p>
 * A JSON value is one of the following: an object ({@link JsonObject}), an
 * array ({@link JsonArray}), a number ({@link JsonNumber}), a string (
 * {@link JsonString}), {@code true} ({@link JsonValue#TRUE JsonValue.TRUE}),
 * {@code false} ({@link JsonValue#FALSE JsonValue.FALSE}), or {@code null} (
 * {@link JsonValue#NULL JsonValue.NULL}).
 *
...
public interface JsonValue {
	...
	static final JsonValue NULL = new JsonValue() {
		...
		/**
		 * Compares the specified object with this {@link JsonValue#NULL} object
		 * for equality. Returns {@code true} if and only if the specified
		 * object is also a {@code JsonValue}, and their {@link #getValueType()}
	...
	static final JsonValue TRUE = new JsonValue() {
		...
		/**
		 * Compares the specified object with this {@link JsonValue#TRUE} object
		 * for equality. Returns {@code true} if and only if the specified
		 * object is also a JsonValue, and their {@link #getValueType()} objects
		 * are <i>equal</i>.
		 *
		 * @param obj
		 *            the object to be compared for equality with this
	...
	static final JsonValue FALSE = new JsonValue() {
		 ...
		 *
		 * @param obj
		 *            the object to be compared for equality with this JsonValue
		 * @return {@code true} if the specified object is equal to this
		 *         JsonValue
		 */
		@Override
