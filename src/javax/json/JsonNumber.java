 ...
 * value internally. The {@code BigDecimal} object can be constructed from the
 * following types: {@link BigDecimal#BigDecimal(int) <code>int</code>},
 ...
 * {@link BigDecimal#BigDecimal(String) <code>String</code>}. Some of the method
 * semantics in this class are defined using the {@code BigDecimal} semantics.
 *
...
public interface JsonNumber extends JsonValue {
	...
	/**
	 * Returns this JSON number as an {@code int}. Note that this conversion can
	 * lose information about the overall magnitude and precision of the number
	 ...
	 *             if the number has a nonzero fractional part or if it does not
	 *             fit in an {@code int}
	...
	/**
	 * Returns this JSON number as a {@code long}. Note that this conversion can
	 * lose information about the overall magnitude and precision of the number
	 * value as well as return a result with the opposite sign.
	 *
	 ...
	 * @return a {@code long} representation of the JSON number
	 * @throws ArithmeticException
	 *             if the number has a non-zero fractional part or if it does
	...
	/**
	 * Returns this JSON number as a {@link BigInteger} object. This is a a
	 * convenience method for {@code bigDecimalValue().toBigInteger()}. Note
	 * that this conversion can lose information about the overall magnitude and
	...
	/**
	 * Returns this JSON number as a {@code double}. This is a a convenience
	 * method for {@code bigDecimalValue().doubleValue()}. Note that this
	...
	/**
	 * Returns a JSON text representation of the JSON number. The representation
	 * is equivalent to {@link BigDecimal#toString()}.
	 *
	...
	/**
	 * Returns the hash code value for this {@code JsonNumber} object. The hash
	 * code of a {@code JsonNumber} object is defined as the hash code of its
	 * {@link #bigDecimalValue()} object.
	 *
