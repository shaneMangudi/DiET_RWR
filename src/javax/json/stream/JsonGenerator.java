...
public interface JsonGenerator extends Flushable, /* Auto */Closeable {
	/**
	 * Configuration property to generate JSON prettily. All providers must
	 * support this property. The value of the property could be be anything.
	 */
	 ...
	 * context is not yet started). This method can only be called once in no
	 * context.
	 *
	 ...
	 *             if this method is called within an object context or if it is
	 ...
	 * context. It starts a new child object context within which JSON
	 * name/value pairs can be written to the object.
	 *
	 * @param name
	 *            a name within the JSON name/object pair to be written
	 * @return this generator
	 * @throws javax.json.JsonException
	 *             if an i/o error occurs (IOException would be cause of
	 *             JsonException)
	 ...
	 * context within which JSON values can be written to the array. This method
	 * is valid only in an array context or in no context (when a context is not
	 * yet started). This method can only be called once in no context.
	 *
	 * @return this generator
	 * @throws javax.json.JsonException
	 *             if an i/o error occurs (IOException would be cause of
	 *             JsonException)
	 * @throws JsonGenerationException
	 *             if this method is called within an object context or if
	 *             called more than once in no context
	 */
	 ...
	 *
	 * @param name
	 *            a name within the JSON name/array pair to be written
	 * @return this generator
	 * @throws javax.json.JsonException
	 *             if an i/o error occurs (IOException would be cause of
	 *             JsonException)
	 ...
	 *
	 * @param name
	 *            a name in the JSON name/value pair to be written in current
	 *            JSON object
	 * @param value
	 *            a value in the JSON name/value pair to be written in current
	 *            JSON object
	 * @return this generator
	 * @throws javax.json.JsonException
	 *             if an i/o error occurs (IOException would be cause of
	...
	/**
	 * Writes a JSON name/string value pair in the current object context. The
	 * specified value is written as JSON string value.
	 *
	 * @param name
	 *            a name in the JSON name/string pair to be written in current
	 *            JSON object
	 * @param value
	 *            a value in the JSON name/string pair to be written in current
	 *            JSON object
	 * @return this generator
	 * @throws javax.json.JsonException
	 *             if an i/o error occurs (IOException would be cause of
	...
	/**
	 * Writes a JSON name/number value pair in the current object context. The
	 * specified value is written as a JSON number value. The string
	 * {@code new BigDecimal(value).toString()} is used as the text value for
	 * writing.
	 *
	 * @param name
	 *            a name in the JSON name/number pair to be written in current
	 *            JSON object
	 * @param value
	 *            a value in the JSON name/number pair to be written in current
	 *            JSON object
	 * @return this generator
	 * @throws javax.json.JsonException
	 *             if an i/o error occurs (IOException would be cause of
	...
	/**
	 * Writes a JSON name/number value pair in the current object context. The
	 * specified value is written as a JSON number value. The specified value's
	 * {@code toString()} is used as the text value for writing.
	 *
	 * @param name
	 *            a name in the JSON name/number pair to be written in current
	 *            JSON object
	 ...
	 * Writes a JSON name/number value pair in the current object context. The
	 * specified value is written as a JSON number value. The string
	 * {@code BigDecimal.valueOf(double).toString()} is used as the text value
	 * for writing.
	 *
	 * @param name
	 *            a name in the JSON name/number pair to be written in current
	...
	/**
	 * Writes a JSON name/boolean value pair in the current object context. If
	 * value is true, it writes the JSON {@code true} value, otherwise it writes
	 * the JSON {@code false} value.
	 *
	 * @param name
	 *            a name in the JSON name/boolean pair to be written in current
	 *            JSON object
	 * @param value
	 *            a value in the JSON name/boolean pair to be written in current
	 *            JSON object
	 * @return this generator
	 * @throws javax.json.JsonException
	 *             if an i/o error occurs (IOException would be cause of
	 ...
	 *
	 * @param name
	 *            a name in the JSON name/null pair to be written in current
	 *            JSON object
	 * @return this generator
	 * @throws javax.json.JsonException
	 *             if an i/o error occurs (IOException would be cause of
	 ...
	 * context, this method writes the end-of-array character (']'). If the
	 * current context is an object context, this method writes the
	 ...
	 *
	 * @param value
	 *            a value to be written in current JSON array
	 * @return this generator
	 * @throws javax.json.JsonException
	 *             if an i/o error occurs (IOException would be cause of
	 *             JsonException)
	...
	/**
	 * Writes the specified value as a JSON string value within the current
	 * array context.
	 *
	 * @param value
	 *            a value to be written in current JSON array
	 ...
	 * array context. The specified value's {@code toString()} is used as the
	...
	/**
	 * Writes the specified value as a JSON number value within the current
	 * array context. The string {@code new BigDecimal(value).toString()} is
	...
	/**
	 * Writes the specified value as a JSON number value within the current
	 * array context. The string {@code BigDecimal.valueOf(value).toString()} is
	 * used as the text value for writing.
	 *
	 * @param value
	 *            a value to be written in current JSON array
	...
	/**
	 * Writes a JSON true or false value within the current array context. If
	 * value is true, this method writes the JSON {@code true} value, otherwise
	...
	/**
	 * Closes this generator and frees any resources associated with it. This
	 * method closes the underlying output source.
	 *
	 * @throws javax.json.JsonException
	 *             if an i/o error occurs (IOException would be cause of
	 *             JsonException)
	...
	/**
	 * Flushes the underlying output source. If the generator has saved any
