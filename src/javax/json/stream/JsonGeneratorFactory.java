...
/**
 * Factory to create {@link JsonGenerator} instances. If a factory instance is
 * configured with some configuration, the configuration applies to all
 * generator instances created using that factory instance.
 *
 * <p>
...
public interface JsonGeneratorFactory {
	...
	/**
	 * Creates a JSON generator to write JSON text to a character stream. The
	 * generator is configured with the factory configuration.
	 *
	 * @param writer
	 ...
	 * generator is configured with the factory's configuration.
	 *
	 * @param out
	 ...
	 * properties that are used to configure the JSON generators. If there are
	 * any specified configuration properties that are not supported by the
	 * provider, they won't be part of the returned map.
	 *
	 * @return a map of supported provider specific properties that are used to
	 *         configure the created generators. The map may be empty but not
	 *         null
	 */
