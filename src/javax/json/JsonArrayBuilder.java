...
/**
 * A builder for creating {@link JsonArray} models from scratch. This interface
 * initializes an empty JSON array model and provides methods to add values to
 * the array model and to return the resulting array. The methods in this class
 * can be chained to add multiple values to the array.
 *
 * <p>
 ...
 *
 * <a id="JsonArrayBuilderExample1"/> The example code below shows how to build
 * a {@code JsonArray} object that represents the following JSON array:
 *
 * <pre>
 * <code>
 * [
 ...
 *
 * <p>
 * This class does <em>not</em> allow <tt>null</tt> to be used as a value while
