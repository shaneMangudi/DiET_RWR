...
/**
 * A builder for creating {@link JsonObject} models from scratch. This interface
 * initializes an empty JSON object model and provides methods to add name/value
 * pairs to the object model and to return the resulting object. The methods in
 * this class can be chained to add multiple name/value pairs to the object.
 *
 * <p>
 ...
 *
 * <a id="JsonObjectBuilderExample1"/> The example code below shows how to build
 * a {@code JsonObject} model that represents the following JSON object:
 *
 * <pre>
 * <code>
 * {
 ...
 *
 * <p>
 * This class does <em>not</em> allow <tt>null</tt> to be used as a name or
...
public interface JsonObjectBuilder {
	 ...
	 * with this object builder where the value is {@code null}. If the object
	 * contains a mapping for the specified name, this method replaces the old
	 * value with {@code null}.
	 *
	 * @param name
	 *            name in the name/value pair
	 * @return this object builder
	...
	/**
	 * Adds a name/{@code JsonObject} pair to the JSON object associated with
	 * this object builder. The value {@code JsonObject} is built from the
	 ...
	 *            name in the name/value pair
	 * @param builder
	 *            the value is the object associated with this builder
	 * @return this object builder
	 * @throws NullPointerException
	 ...
	 * @param builder
	 *            the value is the object array with this builder
	 * @return this object builder
	 * @throws NullPointerException
	 *             if the specified name or builder is null
	 */
